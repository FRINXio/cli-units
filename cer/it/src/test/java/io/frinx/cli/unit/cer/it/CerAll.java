...
//        setRootLogLevel();
    ...
    private void mockDefaultParamsService() {
        doReturn(CLI_CFG.getKeepaliveStrategy()).when(cliDefaultParametersService).getKeepaliveStrategy(any());
        doReturn(CLI_CFG.getDryRunJournalSize()).when(cliDefaultParametersService).getDryrunJournalSize(any());
        doReturn(CLI_CFG.getJournalSize()).when(cliDefaultParametersService).getJournalSize(any());
        doReturn(CLI_CFG.getJournalLevel()).when(cliDefaultParametersService).getJournalLevel(any());
        doReturn(CLI_CFG.getParsingEngine()).when(cliDefaultParametersService).getParsingEngine(any());
        doReturn(CLI_CFG.getMaxConnectionAttempts()).when(cliDefaultParametersService).getMaxConnectionAttempts(any());
        doReturn(CLI_CFG.getMaxReconnectionAttempts()).when(cliDefaultParametersService)
                .getMaxReconnectionAttempts(any());
    }
...
//        localCli.setLevel(Level.TRACE);
    ...
    private void mockBroker() {
        doReturn(CompletableFuture.completedFuture(null)).when(mockTx).submit();
        ...
        doReturn(mockTxChain).when(mockBroker)
