...
class Ipv4AddressReaderTest {
    ...
    @Test
    void testGetAllIds_002() throws Exception {
    ...
    void testMerge_001() throws Exception {
        ...
        assertThat(addressesBuilderA.getAddress().size(), CoreMatchers.is(2));
        assertThat(addressesBuilderA.getAddress().stream().map(Address::getIp).map(Ipv4AddressNoZone::getValue)
