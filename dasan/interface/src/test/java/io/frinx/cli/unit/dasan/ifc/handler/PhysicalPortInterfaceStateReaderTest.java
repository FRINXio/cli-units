...
class PhysicalPortInterfaceStateReaderTest {
    ...
    void testReadCurrentAttributes_001() throws Exception {
        ...
        try (MockedStatic<DasanCliUtil> dasanCliUtilMock = Mockito.mockStatic(DasanCliUtil.class);
             MockedStatic<PhysicalPortInterfaceStateReader> physicalPortInterfaceStateReaderMock =
                     Mockito.mockStatic(PhysicalPortInterfaceStateReader.class)) {
            ...
            physicalPortInterfaceStateReaderMock.verify(() -> PhysicalPortInterfaceStateReader
    ...
    @Test
    void testParseInterfaceState_001() throws Exception {
    ...
    @Test
    void testParseInterfaceState_002() throws Exception {
        final String output = "";
        final StateBuilder builder = Mockito.mock(StateBuilder.class);
        final String name = "Ethernet1/1";
    ...
    @Test
    void testParseInterfaceState_003() throws Exception {
