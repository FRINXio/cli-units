...
class TrunkPortVlanMemberConfigReaderTest {
    ...
    @Test
    void testParseTrunkConfig_001() throws Exception {
        ...
        assertEquals(Integer.valueOf(255), builder.getTrunkVlans().get(0).getVlanId().getValue());
        assertEquals(Integer.valueOf(4089), builder.getTrunkVlans().get(1).getVlanId().getValue());
    }

    @Test
    void testParseTrunkConfig_002() throws Exception {
        ...
        // test
        TrunkPortVlanMemberConfigReader.parseTrunkConfig(output, builder, portList, id);
        assertEquals(Integer.valueOf(4089), builder.getNativeVlan().getValue());
    }
}