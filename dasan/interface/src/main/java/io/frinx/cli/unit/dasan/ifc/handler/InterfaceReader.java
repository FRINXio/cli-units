...
public class InterfaceReader extends CompositeListReader<Interface, InterfaceKey, InterfaceBuilder>
    ...
    public InterfaceReader(Cli cli) {
        super(List.of(
            new PhysicalPortInterfaceReader(cli),
            new TrunkPortInterfaceReader(cli),
            new BundleEtherInterfaceReader(cli),
            new VlanInterfaceReader(cli)
        ));
    }

    @Override
    public void merge(@NotNull Builder<? extends DataObject> builder, @NotNull List<Interface> list) {
        ((InterfacesBuilder) builder).setInterface(list);
    }

    @NotNull
    @Override
    public InterfaceBuilder getBuilder(@NotNull InstanceIdentifier<Interface> instanceIdentifier) {
