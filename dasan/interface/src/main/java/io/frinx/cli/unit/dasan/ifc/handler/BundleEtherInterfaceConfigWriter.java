...
public class BundleEtherInterfaceConfigWriter implements CliWriter<Config>, CompositeWriter.Child<Config> {
    ...
    private static final Set<Class<? extends InterfaceType>> SUPPORTED_INTERFACE_TYPES = Set.of(Ieee8023adLag.class);
    ...
    @Override
    public boolean writeCurrentAttributesWResult(@NotNull InstanceIdentifier<Config> id, @NotNull Config data,
