...
public class L2CftProfileProtocolConfigReaderTest {
    ...
    public void parseConfig() {
        ...
        Assert.assertEquals(Name.CiscoCdp, builder.getName());
        Assert.assertEquals(Disposition.Discard, builder.getDisposition());
    }
}
