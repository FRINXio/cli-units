...
public class L2CftProfileReader implements CliConfigListReader<Profile, ProfileKey, ProfileBuilder> {
    ...
    @NotNull
    @Override
    public List<ProfileKey> getAllIds(@NotNull InstanceIdentifier<Profile> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Profile> instanceIdentifier,
                                      @NotNull ProfileBuilder profileBuilder,
                                      @NotNull ReadContext readContext) throws ReadFailedException {
