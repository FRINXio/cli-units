...
public class LogicalRingReader implements CliConfigListReader<LogicalRing, LogicalRingKey, LogicalRingBuilder> {
    ...
    @Nonnull
    @Override
    public List<LogicalRingKey> getAllIds(@Nonnull InstanceIdentifier<LogicalRing> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@Nonnull InstanceIdentifier<LogicalRing> instanceIdentifier,
                                      @Nonnull LogicalRingBuilder logicalRingBuilder,
                                      @Nonnull ReadContext readContext) throws ReadFailedException {
