...
class VirtualRingReaderTest {
    ...
    private static final String OUTPUT = """
            ...
            ring-protection virtual-ring create virtual-ring-name frinx_test logical-ring l-ring-test2 raps-vid 55
            ring-protection virtual-ring create virtual-ring-name frinx_test2 logical-ring l-ring-test2 raps-vid 56
            ring-protection virtual-ring create virtual-ring-name v-ring-12 logical-ring LOGICAL_FRINX3 raps-vid 4094
            """;
    ...
    void getAllIdsTest() {
        ...
        assertEquals(ringKeys, VirtualRingReader.getAllIds(OUTPUT, "l-ring-test2"));
    }
}
