...
public class LogicalRingReaderTest {
    ...
    static final String OUTPUT =
            ...
            + "raps-vid 103\n"
            + "ring-protection virtual-ring create virtual-ring-name frinx_test logical-ring LOGICAL_FRINX3 "
            + "raps-vid 55\n"
            + "ring-protection virtual-ring create virtual-ring-name frinx_test2 logical-ring LOGICAL_FRINX3 "
            + "raps-vid 56\n"
    ...
    public void getAllIdsTest() {
        ...
        Assert.assertEquals(ringKeys, LogicalRingReader.getAllIds(OUTPUT));
    }
}
