...
public class AclEntryReader implements CliConfigListReader<AclEntry, AclEntryKey, AclEntryBuilder> {
    ...
    @Nonnull
    @Override
    public List<AclEntryKey> getAllIds(@Nonnull InstanceIdentifier<AclEntry> instanceIdentifier,
