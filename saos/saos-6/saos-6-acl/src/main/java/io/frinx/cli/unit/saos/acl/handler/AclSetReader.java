...
public class AclSetReader implements CliConfigListReader<AclSet, AclSetKey, AclSetBuilder> {
    ...
    @NotNull
    @Override
    public List<AclSetKey> getAllIds(@NotNull InstanceIdentifier<AclSet> id,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<AclSet> id,
                                      @NotNull AclSetBuilder builder,
