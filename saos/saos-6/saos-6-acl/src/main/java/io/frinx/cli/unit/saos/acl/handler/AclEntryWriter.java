...
public class AclEntryWriter implements CliWriter<AclEntry> {
    ...
    @Override
    public void writeCurrentAttributes(@NotNull InstanceIdentifier<AclEntry> instanceIdentifier,
                                       @NotNull AclEntry aclEntry,
    ...
    @Override
    public void deleteCurrentAttributes(@NotNull InstanceIdentifier<AclEntry> instanceIdentifier,
                                        @NotNull AclEntry aclEntry,
                                        @NotNull WriteContext writeContext) throws WriteFailedException {
        String aclSetName = instanceIdentifier.firstKeyOf(AclSet.class).getName();
