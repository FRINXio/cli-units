...
public class AclEntryConfigReaderTest {
    ...
    private void buildAndTest(String aclProfile, Long sequenceId, String expectedTermName) {
        ...
        Assert.assertEquals(sequenceId, builder.getSequenceId());
        Assert.assertEquals(expectedTermName, builder.getAugmentation(Config2.class).getTermName());
    }
}
