...
public class SaosCliInitializerUnit extends AbstractUnit {
    ...
    public SaosCliInitializerUnit(@NotNull final TranslationUnitCollector registry) {
        super(registry);
    }
    ...
    @Override
    public Set<Pattern>  getErrorRetryPatterns() {
        return Set.of(Pattern.compile("ERROR: System busy, please try again later"));
    }
