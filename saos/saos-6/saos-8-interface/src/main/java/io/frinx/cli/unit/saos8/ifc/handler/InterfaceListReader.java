...
public class InterfaceListReader extends CompositeListReader<Interface, InterfaceKey, InterfaceBuilder>
        implements CliConfigListReader<Interface, InterfaceKey, InterfaceBuilder> {

    public InterfaceListReader(Cli cli) {
        super(Lists.newArrayList(
                new PortReader(cli),
                new L2VLANInterfaceReader(cli),
                new InterfaceReader(cli)
        ));
    }
}
