...
public class AggregateConfigReader implements CliConfigReader<Config1, Config1Builder> {
    ...
    private static final String SH_PORTS = "configuration search string \"aggregation add agg\"";
    ...
    private boolean isPort(InstanceIdentifier<Config1> id, ReadContext readContext) throws ReadFailedException {
