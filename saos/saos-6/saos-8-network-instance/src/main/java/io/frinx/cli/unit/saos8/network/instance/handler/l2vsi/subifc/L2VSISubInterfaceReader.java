...
public class L2VSISubInterfaceReader implements
        CliConfigListReader<Subinterface, SubinterfaceKey, SubinterfaceBuilder> {
    ...
    public L2VSISubInterfaceReader(Cli cli) {
        this.cli = cli;
    }
    ...
    @VisibleForTesting
    static List<SubinterfaceKey> getAllIds(String output, String vsName) {

        Pattern allIds = Pattern.compile("virtual-switch interface attach sub-port (?<id>\\d+)"
                + " vs " + vsName);
