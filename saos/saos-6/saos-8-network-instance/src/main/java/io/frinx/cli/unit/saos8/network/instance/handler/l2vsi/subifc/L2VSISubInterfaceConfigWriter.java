...
public class L2VSISubInterfaceConfigWriter implements CliWriter<Config> {

    private static final String WRITE_TEMPLATE =
            "virtual-switch interface attach sub-port {$data.name} vs {$vsName}\nconfiguration save";

    private Cli cli;

    public L2VSISubInterfaceConfigWriter(Cli cli) {
        this.cli = cli;
    }
    ...
    public void writeCurrentAttributes(@Nonnull InstanceIdentifier<Config> instanceIdentifier,
        ...
        blockingWriteAndRead(fT(WRITE_TEMPLATE, "data", config, "vsName", vsName),
