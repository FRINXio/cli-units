...
class BroadcastContainmentFilterInterfaceConfigWriterTest {
    @Mock
    private Cli cli;
    ...
    void testWrite() throws Exception {
        ...
        assertEquals("broadcast-containment add filter filter1 port 3\n",
    ...
    void testDelete() throws Exception {
        ...
        assertEquals("broadcast-containment remove filter filter1 port 3\n",
                commands.getValue().getContent());
    }
}
