...
class BroadcastContainmentReaderTest {

    private static final String SH_RUN_BC_OUTPUT = """
    ...
    @Test
    void getAllFilters() throws ReadFailedException {
        ...
        assertEquals(expected, BroadcastContainmentFilterReader.getAllIds(null, cliReader, null, null));
    }
    ...
    void getAllPorts() throws ReadFailedException {
        ...
        assertEquals(expected, BroadcastContainmentFilterInterfaceReader
    ...
    void getAttributes() {
        ...
        assertEquals(BigInteger.valueOf(Integer.parseInt(KBPS)), expected.getRate());
        assertEquals(expectedConCos, expected.getContainmentClasification());
    }
}
