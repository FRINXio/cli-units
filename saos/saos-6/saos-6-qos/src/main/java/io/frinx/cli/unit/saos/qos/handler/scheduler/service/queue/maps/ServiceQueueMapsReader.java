...
public class ServiceQueueMapsReader implements CliConfigListReader<QueueMaps, QueueMapsKey, QueueMapsBuilder> {
    ...
    @Nonnull
    @Override
    public List<QueueMapsKey> getAllIds(@Nonnull InstanceIdentifier<QueueMaps> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@Nonnull InstanceIdentifier<QueueMaps> instanceIdentifier,
                                      @Nonnull QueueMapsBuilder builder,
