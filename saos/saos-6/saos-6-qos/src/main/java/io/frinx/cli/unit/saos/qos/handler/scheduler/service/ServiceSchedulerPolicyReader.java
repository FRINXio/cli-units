...
public class ServiceSchedulerPolicyReader
    ...
    private static final Pattern ALL_IDS = Pattern.compile("traffic-services.*\\d+ port (?<name>\\d+).*");

    private Cli cli;

    public ServiceSchedulerPolicyReader(Cli cli) {
        this.cli = cli;
    }
