...
public class ServiceQueueMapReader implements CliConfigListReader<QueueMap, QueueMapKey, QueueMapBuilder> {
    ...
    @Nonnull
    @Override
    public List<QueueMapKey> getAllIds(@Nonnull InstanceIdentifier<QueueMap> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@Nonnull InstanceIdentifier<QueueMap> instanceIdentifier,
                                      @Nonnull QueueMapBuilder builder,
