...
public class L2VSIConfigCftConfigReader implements CliConfigReader<Config, ConfigBuilder> {

    private Cli cli;

    public L2VSIConfigCftConfigReader(Cli cli) {
        this.cli = cli;
    }
    ...
    public void readCurrentAttributes(@Nonnull InstanceIdentifier<Config> id,
        ...
        builder.setCftName(id.firstKeyOf(Cft.class).getCftName());
    }
}