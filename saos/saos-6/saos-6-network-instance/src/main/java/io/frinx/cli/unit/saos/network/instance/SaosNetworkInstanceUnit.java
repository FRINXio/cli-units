...
import io.frinx.cli.unit.saos.network.instance.handler.vlan.relayagent.RelayAgentVlanConfigReader;
import io.frinx.cli.unit.saos.network.instance.handler.vlan.relayagent.RelayAgentVlanConfigWriter;
import io.frinx.cli.unit.saos.network.instance.handler.vlan.relayagent.port.RelayAgentPortConfigReader;
import io.frinx.cli.unit.saos.network.instance.handler.vlan.relayagent.port.RelayAgentPortConfigWriter;
import io.frinx.cli.unit.saos.network.instance.handler.vlan.relayagent.port.RelayAgentPortReader;
...
public class SaosNetworkInstanceUnit extends AbstractUnit {
    ...
    private void provideWriters(CustomizerAwareWriteRegistryBuilder writeRegistry, Cli cli) {
        ...
        writeRegistry.addNoop(IIDs.NE_NE_VL_VL_AUG_SAOS6VLANRELAYAGENTAUG_RELAYAGENT);
        writeRegistry.add(IIDs.NE_NE_VL_VL_AUG_SAOS6VLANRELAYAGENTAUG_RE_CONFIG,
                new RelayAgentVlanConfigWriter(cli));
        writeRegistry.addNoop(IIDs.NE_NE_VL_VL_AUG_SAOS6VLANRELAYAGENTAUG_RE_CO_PORTS);
        writeRegistry.add(IIDs.NE_NE_VL_VL_AUG_SAOS6VLANRELAYAGENTAUG_RE_CO_PO_CONFIG,
                new RelayAgentPortConfigWriter(cli));
    }
    ...
    private void provideReaders(CustomizerAwareReadRegistryBuilder readRegistry, Cli cli) {
        ...
        readRegistry.add(IIDs.NE_NE_VL_VL_AUG_SAOS6VLANRELAYAGENTAUG_RE_CONFIG,
                new RelayAgentVlanConfigReader(cli));
        readRegistry.add(IIDs.NE_NE_VL_VL_AUG_SAOS6VLANRELAYAGENTAUG_RE_CO_PORTS, new RelayAgentPortReader(cli));
        readRegistry.add(IIDs.NE_NE_VL_VL_AUG_SAOS6VLANRELAYAGENTAUG_RE_CO_PO_CONFIG,
                new RelayAgentPortConfigReader(cli));
    }
}