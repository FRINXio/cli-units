...
public class L2VSIPointsReader
    ...
    @NotNull
    @Override
    public List<ConnectionPointKey> getAllIds(@NotNull InstanceIdentifier<ConnectionPoint> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<ConnectionPoint> instanceIdentifier,
                                      @NotNull ConnectionPointBuilder connectionPointBuilder,
                                      @NotNull ReadContext readContext) throws ReadFailedException {
