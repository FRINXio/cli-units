...
class L2VSIConfigWriterTest {
    ...
    @Test
    void testWriteNoDesc() throws Exception {
    ...
    @Test
    void testWriteDisableL2pt() throws Exception {
    ...
    @Test
    void testWriteNoL2pt() throws Exception {
    ...
    void testDelete() throws Exception {
        ...
        assertEquals("virtual-switch ethernet delete vs VLAN111444", commands.getValue().getContent());
    }
    ...
    void testUpdateTemplate() {
        ...
        // description
        assertEquals("virtual-switch ethernet set vs VLAN111444 description \"desc2\"\n",
                writer.updateTemplate(
        ...
        assertEquals("virtual-switch ethernet set vs VLAN111444 encap-fixed-dot1dpri 5\n",
                writer.updateTemplate(
                createConfig("desc1", (short) 3, EncapCosPolicy.Fixed, true),
                createConfig("desc1", (short) 5, EncapCosPolicy.Fixed, true), "VLAN111444"));

        // encap-cos-policy
        assertEquals("virtual-switch ethernet set vs VLAN111444 encap-cos-policy port-inherit\n",
                writer.updateTemplate(
                createConfig("desc1", (short) 3, EncapCosPolicy.Fixed, true),
        ...
        assertEquals("""
                        virtual-switch ethernet set vs VLAN111444 description "desc2"
                        l2-cft tagged-pvst-l2pt disable vs VLAN111444
    ...
    private void createCommandAndTest(Config data, String expected) throws WriteFailedException {
        ...
        assertEquals(expected, commands.getValue().getContent());
    }
