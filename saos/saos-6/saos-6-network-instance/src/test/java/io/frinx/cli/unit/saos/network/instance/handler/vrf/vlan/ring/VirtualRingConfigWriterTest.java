...
class VirtualRingConfigWriterTest {
    ...
    void writeCurrentAttributesTest() throws WriteFailedException {
        ...
        assertEquals("ring-protection virtual-ring add ring v-ring1 vid 2",
    ...
    void deleteCurrentAttributesTest() throws WriteFailedException {
        ...
        Mockito.verify(cli).executeAndRead(commands.capture());
        assertEquals("ring-protection virtual-ring remove ring v-ring1 vid 2",
                commands.getValue().getContent());
    }
}