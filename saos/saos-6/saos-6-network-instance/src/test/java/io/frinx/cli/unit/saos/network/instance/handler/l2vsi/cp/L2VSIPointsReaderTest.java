...
class L2VSIPointsReaderTest {
    ...
    private static final String OUTPUT = """
            ...
            traffic-profiling standard-profile create port 1 profile 1 name test3 cir 5056 eir 0 cbs 128 ebs 0 vs \
            Optic_test2
            traffic-profiling standard-profile create port 2 profile 1 name test cir 2048 eir 0 cbs 128 ebs 0 vs \
            Optic_test2
    ...
    @Test
    void getAllIdsTest() {
        assertEquals(Collections.singletonList(new ConnectionPointKey("vc2721")),
