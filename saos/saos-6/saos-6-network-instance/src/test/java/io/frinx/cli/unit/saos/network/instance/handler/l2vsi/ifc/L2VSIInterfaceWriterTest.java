...
class L2VSIInterfaceWriterTest {

    private static final String L2_VSI_INTERFACE_DELETE_INPUT = """
            virtual-switch ethernet remove vs VLAN111444 port 4
    ...
    void testWrite() throws Exception {
        ...
        assertEquals("""
                        virtual-switch ethernet add vs VLAN111444 port 4
    ...
    void testDelete() throws Exception {
        ...
        Mockito.verify(cli).executeAndRead(commands.capture());
        assertEquals(L2_VSI_INTERFACE_DELETE_INPUT, commands.getValue().getContent());
    }
}
