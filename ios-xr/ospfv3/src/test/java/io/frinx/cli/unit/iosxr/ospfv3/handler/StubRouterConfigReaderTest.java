...
class StubRouterConfigReaderTest {
    ...
    @Test
    void testReadCurrentAttributesForType() throws ReadFailedException {
        ...
        // verify
        assertEquals(STUBROUTERMAXMETRIC.class, builder.build().getAdvertiseLsasTypes());
        assertTrue(builder.build().isSet());
        assertTrue(builder.build().isAlways());
    }
}
