...
public class TeConfigReaderTest {
    ...
    private static final String NO_OUTPUT = "Fri Jan 19 11:52:35.794 UTC\n"
            + "interface GigabitEthernet0/0/0/1\n"
            + "!\n";
    ...
    @Test
    public void testMplsEnabled() throws Exception {
    ...
    @Test
    public void testMplsDisabled() throws Exception {
