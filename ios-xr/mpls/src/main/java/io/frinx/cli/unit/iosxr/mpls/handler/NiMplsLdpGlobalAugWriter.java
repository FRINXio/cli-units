...
public class NiMplsLdpGlobalAugWriter implements CliWriter<NiMplsLdpGlobalAug> {
    ...
    @Override
    public void writeCurrentAttributes(@NotNull InstanceIdentifier<NiMplsLdpGlobalAug> id,
            @NotNull NiMplsLdpGlobalAug data, @NotNull WriteContext writeContext) throws WriteFailedException {
    ...
    @Override
    public void updateCurrentAttributes(@NotNull final InstanceIdentifier<NiMplsLdpGlobalAug> id,
                                        @NotNull final NiMplsLdpGlobalAug dataBefore,
                                        @NotNull final NiMplsLdpGlobalAug dataAfter,
                                        @NotNull final WriteContext writeContext) throws WriteFailedException {
        writeCurrentAttributes(id, dataAfter, writeContext);
    }

    @Override
    public void deleteCurrentAttributes(@NotNull InstanceIdentifier<NiMplsLdpGlobalAug> id, @NotNull
            NiMplsLdpGlobalAug data, @NotNull WriteContext writeContext) throws WriteFailedException {
