...
package io.frinx.cli.unit.iosxr.evpn;
...
import io.frinx.cli.unit.iosxr.evpn.handler.EvpnConfigReader;
import io.frinx.cli.unit.iosxr.evpn.handler.EvpnConfigWriter;
...
public class EvpnUnit extends AbstractUnit {
    ...
    public EvpnUnit(@NotNull final TranslationUnitCollector registry) {
        super(registry);
    }
