...
public class HsrpGroupReader implements CliConfigListReader<HsrpGroup, HsrpGroupKey, HsrpGroupBuilder> {
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<HsrpGroup> instanceIdentifier,
            @NotNull HsrpGroupBuilder hsrpGroupBuilder, @NotNull ReadContext readContext) throws ReadFailedException {
