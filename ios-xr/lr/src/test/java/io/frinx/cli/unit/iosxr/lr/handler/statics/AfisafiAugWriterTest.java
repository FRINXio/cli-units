...
public class AfisafiAugWriterTest {
    @Mock
    ...
    public void testWriteCurrentAttributesNotDefaultNetwork() throws WriteFailedException {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testDeleteCurrentAttributesHasNextHop() throws WriteFailedException {
