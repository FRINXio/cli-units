...
public class NextHopListWriter implements CliListWriter<NextHop, NextHopKey> {
    ...
    private static final String COMMAND_TEMPLATE = "router static\n"
            + "address-family {$afisafi}\n"
            + "{% if $delete %}no{% endif %} {$ip} {$etherIp} {$nexthopIp}"
            + "{% if (!$delete) %} {$tagValue}{% endif %}\n"
            + "root";
    ...
    @Override
    public void writeCurrentAttributes(InstanceIdentifier<NextHop> iid, NextHop nexthop,
    ...
    @Override
    public void updateCurrentAttributes(InstanceIdentifier<NextHop> iid,
                                        NextHop before,
                                        NextHop after,
                                               WriteContext context) throws WriteFailedException {
    ...
    @Override
    public void deleteCurrentAttributes(InstanceIdentifier<NextHop> iid, NextHop before,
                                               WriteContext context) throws WriteFailedException {
