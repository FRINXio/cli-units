...
public class NextHopListReader implements CliConfigListReader<NextHop, NextHopKey, NextHopBuilder> {
    ...
    @NotNull
    @Override
    public List<NextHopKey> getAllIds(@NotNull InstanceIdentifier<NextHop> id, @NotNull ReadContext context)
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<NextHop> id, @NotNull NextHopBuilder builder,
    ...
    private void fillNextHopBuilder(
        @NotNull InstanceIdentifier<NextHop> id,
        @NotNull String index,
        @NotNull ReadContext context,
        @NotNull IpPrefix pf,
        @NotNull NextHopBuilder builder
    )throws ReadFailedException {
        ...
        List<String> nexthops = ParsingUtils.parseFields(
            ...
            m -> m.group("nexthop"),
            value -> value);
        String nexthop = nexthops.get(Integer.parseInt(index) - 1);
