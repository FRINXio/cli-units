...
public class AfisafiAugWriter implements CliWriter<AfiSafiAug> {
    ...
    @Override
    public void writeCurrentAttributes(@Nonnull InstanceIdentifier<AfiSafiAug> id,
                                       @Nonnull AfiSafiAug data,
    ...
    @Override
    public void updateCurrentAttributes(@Nonnull InstanceIdentifier<AfiSafiAug> id,
                                        @Nonnull AfiSafiAug dataBefore,
                                        @Nonnull AfiSafiAug dataAfter,
                                        @Nonnull WriteContext writeContext) throws WriteFailedException {
        if (!ChecksMap.PathCheck.Protocol.STATIC_ROUTING.canProcess(id, writeContext, false)) {
            return;
        }
    ...
    @Override
    public void deleteCurrentAttributes(@Nonnull InstanceIdentifier<AfiSafiAug> id,
                                        @Nonnull AfiSafiAug dataBefore,
                                        @Nonnull WriteContext writeContext) throws WriteFailedException {
