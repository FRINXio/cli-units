...
public class StaticListReader implements CliConfigListReader<Static, StaticKey, StaticBuilder> {
    ...
    @NotNull
    @Override
    public List<StaticKey> getAllIds(@NotNull InstanceIdentifier<Static> id, @NotNull ReadContext context)
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Static> id, @NotNull StaticBuilder builder,
