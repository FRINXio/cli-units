...
public class MemberConfigWriter implements CliWriter<Config> {
    ...
    private static final String LACP_OPERATION_MODE_TEMPLATE = "mode"
            ...
            + "{% endif %}"
            + "\n";
    static final String LACP_PERIOD_TEMPLATE = """
    ...
    private static final String IFC_ETHERNET_CONFIG_TEMPLATE = "interface {$ifc_name}\n"
            ...
            + "root";
    private static final String IFC_ETHERNET_REMOVE_CONFIG_TEMPLATE = """
            interface {$ifc_name}
            no bundle id
    ...
    void writeMemberConfig(@NotNull InstanceIdentifier<Config> instanceIdentifier, @NotNull Config config,
    ...
    private void checkIfcType(@NotNull String ifcName) {
