...
public class MemberReader implements CliConfigListReader<Member, MemberKey, MemberBuilder> {
    ...
    @NotNull
    @Override
    public List<MemberKey> getAllIds(@NotNull InstanceIdentifier<Member> instanceIdentifier,
    ...
    static List<MemberKey> parseMemberKeys(@NotNull String commandOutput, @NotNull String bundleName) {
    ...
    private static String parseInterfaceName(@NotNull String interfaceConfiguration) {
    ...
    private static boolean isItIsInterfaceOfBundle(@NotNull Pattern specificBundlePattern,
                                                   @NotNull String interfaceConfiguration) {
        return Arrays.stream(ParsingUtils.NEWLINE.split(interfaceConfiguration))
                .map(specificBundlePattern::matcher)
                .anyMatch(Matcher::matches);
    }

    static String parseBundleIdFromBundleName(@NotNull String bundleName) {
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Member> instanceIdentifier,
                                      @NotNull MemberBuilder memberBuilder, @NotNull ReadContext readContext) {
