...
package io.frinx.cli.unit.iosxr.qos;
...
import io.frinx.cli.unit.iosxr.qos.handler.classifier.ActionConfigReader;
import io.frinx.cli.unit.iosxr.qos.handler.classifier.ActionsWriter;
import io.frinx.cli.unit.iosxr.qos.handler.classifier.ClassifierConfigReader;
import io.frinx.cli.unit.iosxr.qos.handler.classifier.ClassifierReader;
import io.frinx.cli.unit.iosxr.qos.handler.classifier.ClassifierWriter;
import io.frinx.cli.unit.iosxr.qos.handler.classifier.ConditionsReader;
import io.frinx.cli.unit.iosxr.qos.handler.classifier.RemarkConfigReader;
import io.frinx.cli.unit.iosxr.qos.handler.classifier.TermReader;
import io.frinx.cli.unit.iosxr.qos.handler.scheduler.InputConfigReader;
import io.frinx.cli.unit.iosxr.qos.handler.scheduler.InputConfigWriter;
import io.frinx.cli.unit.iosxr.qos.handler.scheduler.InputReader;
import io.frinx.cli.unit.iosxr.qos.handler.scheduler.OneRateTwoColorConfigReader;
import io.frinx.cli.unit.iosxr.qos.handler.scheduler.OneRateTwoColorConfigWriter;
import io.frinx.cli.unit.iosxr.qos.handler.scheduler.SchedulerPolicyReader;
import io.frinx.cli.unit.iosxr.qos.handler.scheduler.SchedulerPolicyWriter;
import io.frinx.cli.unit.iosxr.qos.handler.scheduler.SchedulerReader;
...
public class XRQoSUnit extends AbstractUnit {
    ...
    public XRQoSUnit(@NotNull final TranslationUnitCollector registry) {
        super(registry);
    }
