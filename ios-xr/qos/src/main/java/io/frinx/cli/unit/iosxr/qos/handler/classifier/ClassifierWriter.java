...
public class ClassifierWriter implements CliWriter<Classifier> {
    ...
    @Override
    public void writeCurrentAttributes(@NotNull InstanceIdentifier<Classifier> instanceIdentifier, @NotNull
            Classifier classifier, @NotNull WriteContext writeContext) throws WriteFailedException {
    ...
    private void writeMatchAny(InstanceIdentifier<Classifier> instanceIdentifier, Classifier classifier, String
        ...
        for (Term t : sortedTerms) {
            Preconditions.checkArgument(checkCount == Integer.parseInt(t.getId()),
    ...
    @Override
    public void updateCurrentAttributes(@NotNull InstanceIdentifier<Classifier> id, @NotNull Classifier dataBefore,
                                        @NotNull Classifier dataAfter, @NotNull WriteContext writeContext) throws
    ...
    @Override
    public void deleteCurrentAttributes(@NotNull InstanceIdentifier<Classifier> instanceIdentifier, @NotNull
            Classifier classifier, @NotNull WriteContext writeContext) throws WriteFailedException {
        final String className = instanceIdentifier.firstKeyOf(Classifier.class)
                .getName();
