...
public class ClassifierReader implements CliConfigListReader<Classifier, ClassifierKey, ClassifierBuilder> {
    ...
    @NotNull
    @Override
    public List<ClassifierKey> getAllIds(@NotNull InstanceIdentifier<Classifier> instanceIdentifier, @NotNull
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Classifier> instanceIdentifier, @NotNull
            ClassifierBuilder builder, @NotNull ReadContext readContext) throws ReadFailedException {
