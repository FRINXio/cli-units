...
public class TermReader implements CliConfigListReader<Term, TermKey, TermBuilder> {
    ...
    @NotNull
    @Override
    public List<TermKey> getAllIds(@NotNull InstanceIdentifier<Term> instanceIdentifier, @NotNull ReadContext
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Term> instanceIdentifier, @NotNull TermBuilder
            termBuilder, @NotNull ReadContext readContext) throws ReadFailedException {
