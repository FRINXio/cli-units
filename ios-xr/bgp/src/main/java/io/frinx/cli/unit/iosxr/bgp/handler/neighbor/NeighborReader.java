...
public class NeighborReader implements CliConfigListReader<Neighbor, NeighborKey, NeighborBuilder> {
    ...
    @Override
    public List<NeighborKey> getAllIds(@NotNull InstanceIdentifier<Neighbor> instanceIdentifier, @NotNull
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Neighbor> instanceIdentifier, @NotNull
            NeighborBuilder neighborBuilder, @NotNull ReadContext readContext) throws ReadFailedException {
