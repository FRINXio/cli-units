...
public class NeighborAfiSafiConfigWriterTest {

    private String input;
    private String output;

    public NeighborAfiSafiConfigWriterTest(String input, String output) {
        this.input = input;
        this.output = output;
    }
    ...
    static String outp = cliF.fT(NeighborAfiSafiConfigWriter.MOD_CURR_ATTR,
            "as", g,
            "instName", "instName",
            "neighbAddr", "neighbAddr",
            "afiSafi", "afiSafi",
            "reConfCommand", "reConfCommand");

    static String outpD = cliF.fT(NeighborAfiSafiConfigWriter.MOD_CURR_ATTR,
            "as", g,
            "instName", "instName",
            "neighbAddr", "neighbAddr",
            "afiSafi", "afiSafi",
