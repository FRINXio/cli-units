...
package io.frinx.cli.unit.iosxr.logging;
...
import io.frinx.cli.unit.iosxr.logging.handler.LoggingInterfaceConfigWriter;
import io.frinx.cli.unit.iosxr.logging.handler.LoggingInterfacesReader;
...
public final class LoggingUnit extends AbstractUnit {
    ...
    public LoggingUnit(@NotNull final TranslationUnitCollector registry) {
        super(registry);
    }
