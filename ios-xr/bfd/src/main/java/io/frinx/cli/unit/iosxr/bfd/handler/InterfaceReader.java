...
public class InterfaceReader implements CliConfigListReader<Interface, InterfaceKey, InterfaceBuilder> {
    ...
    List<InterfaceKey> parseInterfaceIds(@NotNull String interfacesConfiguration) {
    ...
    private boolean checkInterfaceConfiguration(@NotNull String interfaceConfiguration) {
    ...
    private static String extractInterfaceId(@NotNull String interfaceConfiguration) {
