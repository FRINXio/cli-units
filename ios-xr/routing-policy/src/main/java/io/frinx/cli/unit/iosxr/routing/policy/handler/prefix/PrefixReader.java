...
public class PrefixReader implements CliConfigListReader<Prefix, PrefixKey, PrefixBuilder> {
    ...
    @NotNull
    @Override
    public List<PrefixKey> getAllIds(@NotNull InstanceIdentifier<Prefix> id,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Prefix> id,
                                      @NotNull PrefixBuilder builder,
