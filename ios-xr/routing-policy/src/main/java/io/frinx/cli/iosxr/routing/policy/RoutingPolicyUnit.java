...
public class RoutingPolicyUnit implements TranslateUnit {
    ...
    public static final InstanceIdentifier<DefinedSets2> IIDS_DS_BGP_AUG = IIDs.RO_DEFINEDSETS.augmentation(DefinedSets2.class);
    public static final InstanceIdentifier<BgpDefinedSets> IIDS_BGP_DEF_SETS = IIDS_DS_BGP_AUG.child(BgpDefinedSets.class);
    public static final InstanceIdentifier<CommunitySets> IIDS_BGP_COMM_SETS = IIDS_BGP_DEF_SETS.child(CommunitySets.class);
    public static final InstanceIdentifier<CommunitySet> IIDS_BGP_COMM_SET = IIDS_BGP_COMM_SETS.child(CommunitySet.class);
    ...
    public static final InstanceIdentifier<org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.bgp.policy.rev170730.as.path.set.top.as.path.sets.as.path.set.Config> IIDS_AS_PATH_SET_CFG =
            IIDS_AS_PATH_SET.child(org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.bgp.policy.rev170730.as.path.set.top.as.path.sets.as.path.set.Config.class);

    public static final InstanceIdentifier<Statements> STATEMENTS_ID = InstanceIdentifier.create(Statements.class);

    // Conditions
    public static final InstanceIdentifier<Conditions2> BGP_CONDITIONS_AUG_ID = IIDs.RO_PO_PO_ST_ST_CONDITIONS.augmentation(Conditions2.class);
    public static final InstanceIdentifier<BgpConditions> BGP_CONDITIONS_ID = BGP_CONDITIONS_AUG_ID.child(BgpConditions.class);
    public static final InstanceIdentifier<org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.bgp.policy.rev170730.bgp.conditions.top.bgp.conditions.Config> BGP_CONDITIONS_CFG_ID =
            BGP_CONDITIONS_ID.child(org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.bgp.policy.rev170730.bgp.conditions.top.bgp.conditions.Config.class);

    public static final InstanceIdentifier<AsPathLength> AS_PATH_COND_ID = BGP_CONDITIONS_ID.child(AsPathLength.class);
    public static final InstanceIdentifier<org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.bgp.policy.rev170730.as.path.length.top.as.path.length.Config> AS_PATH_COND_CFG_ID =
            AS_PATH_COND_ID.child(org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.bgp.policy.rev170730.as.path.length.top.as.path.length.Config.class);

    public static final InstanceIdentifier<MatchAsPathSet> MATCH_AS_PATH_COND_ID = BGP_CONDITIONS_ID.child(MatchAsPathSet.class);
    public static final InstanceIdentifier<org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.bgp.policy.rev170730.match.as.path.top.match.as.path.set.Config> MATCH_AS_PATH_COND_CFG_ID =
            MATCH_AS_PATH_COND_ID.child(org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.bgp.policy.rev170730.match.as.path.top.match.as.path.set.Config.class);

    public static final InstanceIdentifier<MatchCommunitySet> MATCH_COMMUNITY_COND_ID = BGP_CONDITIONS_ID.child(MatchCommunitySet.class);
    public static final InstanceIdentifier<org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.bgp.policy.rev170730.match.community.top.match.community.set.Config> MATCH_COMMUNITY_COND_CFG_ID =
            MATCH_COMMUNITY_COND_ID.child(org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.bgp.policy.rev170730.match.community.top.match.community.set.Config.class);
    ...
    // Actions
    public static final InstanceIdentifier<Actions2> BGP_ACTIONS_AUG_ID = IIDs.RO_PO_PO_ST_ST_ACTIONS.augmentation(Actions2.class);
    public static final InstanceIdentifier<BgpActions> BGP_ACTIONS_ID = BGP_ACTIONS_AUG_ID.child(BgpActions.class);
    public static final InstanceIdentifier<org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.bgp.policy.rev170730.bgp.actions.top.bgp.actions.Config> BGP_ACTIONS_CFG_ID =
            BGP_ACTIONS_ID.child(org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.bgp.policy.rev170730.bgp.actions.top.bgp.actions.Config.class);

    public static final InstanceIdentifier<SetAsPathPrepend> AS_PATH_PREPEND_ACT_ID = BGP_ACTIONS_ID.child(SetAsPathPrepend.class);
    public static final InstanceIdentifier<org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.bgp.policy.rev170730.as.path.prepend.top.set.as.path.prepend.Config> AS_PATH_PREPAND_ACT_CFG_ID =
            AS_PATH_PREPEND_ACT_ID.child(org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.bgp.policy.rev170730.as.path.prepend.top.set.as.path.prepend.Config.class);

    public static final InstanceIdentifier<SetCommunity> SET_COMMUNITY_ACT_ID = BGP_ACTIONS_ID.child(SetCommunity.class);
    ...
    private void provideWriters(ModifiableWriterRegistryBuilder wRegistry, Cli cli) {
        // Prefix sets
        wRegistry.add(new GenericWriter<>(IIDs.RO_DE_PREFIXSETS, new NoopCliWriter<>()));
        wRegistry.add(new GenericListWriter<>(IIDs.RO_DE_PR_PREFIXSET, new NoopCliListWriter<>()));
        wRegistry.add(new GenericWriter<>(IIDs.RO_DE_PR_PR_CONFIG, new PrefixSetConfigWriter(cli)));
        ...
        wRegistry.subtreeAddAfter(
                Sets.newHashSet(
                        ...
                        RWUtils.cutIdFromStart(IIDs.RO_DE_PR_PR_PR_PR_CONFIG, InstanceIdentifier.create(Prefixes.class))
                ),
                new GenericWriter<>(IIDs.RO_DE_PR_PR_PREFIXES, new PrefixesWriter(cli)),
                IIDs.RO_DE_PR_PR_CONFIG);

        // Community sets
        wRegistry.add(new GenericWriter<>(IIDS_DS_BGP_AUG, new NoopCliWriter<>()));
        wRegistry.add(new GenericWriter<>(IIDS_BGP_DEF_SETS, new NoopCliWriter<>()));
        wRegistry.add(new GenericWriter<>(IIDS_BGP_COMM_SETS, new NoopCliWriter<>()));
        wRegistry.add(new GenericListWriter<>(IIDS_BGP_COMM_SET, new NoopCliListWriter<>()));
        wRegistry.add(new GenericWriter<>(IIDS_BGP_COMM_SET_CFG, new CommunitySetConfigWriter(cli)));

        // As path sets
        wRegistry.add(new GenericWriter<>(IIDS_AS_PATH_SETS, new NoopCliWriter<>()));
        wRegistry.add(new GenericListWriter<>(IIDS_AS_PATH_SET, new NoopCliListWriter<>()));
        wRegistry.add(new GenericWriter<>(IIDS_AS_PATH_SET_CFG, new AsPathSetConfigWriter(cli)));

        // Policy definition
        wRegistry.add(new GenericListWriter<>(IIDs.RO_PO_POLICYDEFINITION, new NoopCliListWriter<>()));
        wRegistry.addAfter(
        ...
        wRegistry.subtreeAddAfter(STATEMENTS_SUBTREES,
    ...
    private void provideReaders(@Nonnull ModifiableReaderRegistryBuilder rRegistry, Cli cli) {
        ...
        // Prefix sets
        rRegistry.addStructuralReader(IIDs.RO_DE_PREFIXSETS, PrefixSetsBuilder.class);
        rRegistry.add(new GenericConfigListReader<>(IIDs.RO_DE_PR_PREFIXSET, new PrefixSetReader(cli)));
        rRegistry.add(new GenericConfigReader<>(IIDs.RO_DE_PR_PR_CONFIG, new PrefixSetConfigReader()));
        rRegistry.addStructuralReader(IIDs.RO_DE_PR_PR_PREFIXES, PrefixesBuilder.class);
        rRegistry.add(new GenericConfigListReader<>(IIDs.RO_DE_PR_PR_PR_PREFIX, new PrefixReader(cli)));
        rRegistry.add(new GenericConfigReader<>(IIDs.RO_DE_PR_PR_PR_PR_CONFIG, new PrefixConfigReader()));

        // Community sets
        rRegistry.addStructuralReader(IIDS_DS_BGP_AUG, DefinedSets2Builder.class);
        rRegistry.addStructuralReader(IIDS_BGP_DEF_SETS, BgpDefinedSetsBuilder.class);
        rRegistry.addStructuralReader(IIDS_BGP_COMM_SETS, CommunitySetsBuilder.class);
        rRegistry.add(new GenericConfigListReader<>(IIDS_BGP_COMM_SET, new CommunitySetReader(cli)));
        rRegistry.add(new GenericConfigReader<>(IIDS_BGP_COMM_SET_CFG, new CommunitySetConfigReader(cli)));

        // As path sets
        rRegistry.addStructuralReader(IIDS_AS_PATH_SETS, AsPathSetsBuilder.class);
        rRegistry.add(new GenericConfigListReader<>(IIDS_AS_PATH_SET, new AsPathSetReader(cli)));
        rRegistry.add(new GenericConfigReader<>(IIDS_AS_PATH_SET_CFG, new AsPathSetConfigReader(cli)));

        // Policy definition
        rRegistry.addStructuralReader(IIDs.RO_POLICYDEFINITIONS, PolicyDefinitionsBuilder.class);
        rRegistry.add(new GenericConfigListReader<>(IIDs.RO_PO_POLICYDEFINITION, new PolicyReader(cli)));
        rRegistry.add(new GenericConfigReader<>(IIDs.RO_PO_PO_CONFIG, new PolicyConfigReader()));
        rRegistry.subtreeAdd(STATEMENTS_SUBTREES,
    ...
    public Set<YangModuleInfo> getYangSchemas() {
        return Sets.newHashSet($YangModuleInfoImpl.getInstance(),
                org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.bgp.policy.rev170730.$YangModuleInfoImpl.getInstance());
    }
