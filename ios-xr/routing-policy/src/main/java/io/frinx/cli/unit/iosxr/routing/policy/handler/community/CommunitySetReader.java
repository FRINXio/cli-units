...
package io.frinx.cli.unit.iosxr.routing.policy.handler.community;
...
public class CommunitySetReader implements CliConfigListReader<CommunitySet, CommunitySetKey, CommunitySetBuilder> {
    ...
    @NotNull
    @Override
    public List<CommunitySetKey> getAllIds(@NotNull InstanceIdentifier<CommunitySet> id, @NotNull ReadContext
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<CommunitySet> id, @NotNull CommunitySetBuilder
            builder, @NotNull ReadContext ctx) throws ReadFailedException {
