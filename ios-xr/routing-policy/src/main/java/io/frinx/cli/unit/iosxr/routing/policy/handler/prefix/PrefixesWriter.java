...
public class PrefixesWriter implements CliWriter<Prefixes> {
    ...
    @Override
    public void writeCurrentAttributes(@NotNull InstanceIdentifier<Prefixes> instanceIdentifier,
                                       @NotNull Prefixes prefixes,
    ...
    @Override
    public void updateCurrentAttributes(@NotNull InstanceIdentifier<Prefixes> id,
                                        @NotNull Prefixes dataBefore,
                                        @NotNull Prefixes dataAfter,
                                        @NotNull WriteContext writeContext) throws WriteFailedException {
    ...
    @Override
    public void deleteCurrentAttributes(@NotNull InstanceIdentifier<Prefixes> instanceIdentifier,
                                        @NotNull Prefixes prefixes,
                                        @NotNull WriteContext writeContext) throws WriteFailedException {
        PrefixSetKey prefixSetKey = instanceIdentifier.firstKeyOf(PrefixSet.class);
