...
class SnmpInterfacesReaderTest {

    private static final String SH_RUN_SNMP_SERVER = """
            Thu Feb 15 11:40:49.064 UTC
    ...
    void testParseInterfaces() {
        ...
        assertEquals(EXPECTED_IFCS, interfacesBuilder.build());
    }
