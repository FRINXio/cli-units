...
public class IngressFlowConfigWriterTest {

    private String input;
    private String output;

    public IngressFlowConfigWriterTest(String input, String output) {
        this.input = input;
        this.output = output;
    }

    static final String EXP_MOD_CURR_ATTR = "interface ifcName\n" +
            "flow netflow_type monitor monitor_name sampler sampler_name ingress\n" +
            "exit";

    static final String EXP_MOD_CURR_ATTR_D = "interface ifcName\n" +
            "no flow netflow_type monitor monitor_name ingress\n" +
            "exit";

    static final String EXP_MOD_CURR_ATTR_S = "interface ifcName\n" +
            "flow netflow_type monitor monitor_name ingress\n" +
            "exit";
    ...
    static String outp = cliF.fT(IngressFlowConfigWriter.MOD_CURR_ATTR,
            "ifcName", "ifcName",
            "netflowType", "netflow_type",
            "dataAfter", dataAfter);


    static String outpD = cliF.fT(IngressFlowConfigWriter.MOD_CURR_ATTR,
            "ifcName", "ifcName",
            "netflowType", "netflow_type",
            "dataAfter", dataAfter,
            "delete", true);

    static String outpS = cliF.fT(IngressFlowConfigWriter.MOD_CURR_ATTR,
            "ifcName", "ifcName",
            "netflowType", "netflow_type",
