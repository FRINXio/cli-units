...
public class IngressFlowReader implements CliConfigListReader<IngressFlow, IngressFlowKey, IngressFlowBuilder> {
    ...
    @NotNull
    @Override
    public List<IngressFlowKey> getAllIds(@NotNull InstanceIdentifier<IngressFlow> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<IngressFlow> instanceIdentifier, @NotNull
            IngressFlowBuilder ingressFlowBuilder, @NotNull ReadContext readContext) throws ReadFailedException {
