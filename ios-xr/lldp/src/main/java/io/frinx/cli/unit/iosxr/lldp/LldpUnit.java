...
public class LldpUnit extends AbstractUnit {
    ...
    public LldpUnit(@NotNull final TranslationUnitCollector registry) {
        super(registry);
    ...
    @Override
    public void provideHandlers(@NotNull CustomizerAwareReadRegistryBuilder writeRegistry,
                                @NotNull CustomizerAwareWriteRegistryBuilder readRegistry,
