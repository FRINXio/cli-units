...
public class RpfCheckIpv6Writer implements CliWriter<Ipv6> {
    ...
    @Override
    public void writeCurrentAttributes(@NotNull final InstanceIdentifier<Ipv6> instanceIdentifier, @NotNull final
        Ipv6 dataAfter,
    ...
    @VisibleForTesting
    StringBuilder prepareCmd(final @NotNull Ipv6 dataAfter) {
    ...
    @Override
    public void updateCurrentAttributes(@NotNull final InstanceIdentifier<Ipv6> id, @NotNull final Ipv6 dataBefore,
                                        @NotNull final Ipv6 dataAfter, @NotNull final WriteContext writeContext)
    ...
    @Override
    public void deleteCurrentAttributes(@NotNull final InstanceIdentifier<Ipv6> instanceIdentifier, @NotNull final
        Ipv6 dataBefore,
                                        @NotNull final WriteContext writeContext) throws WriteFailedException {
        final String interfaceName = instanceIdentifier.firstKeyOf(Interface.class)
                .getName();
