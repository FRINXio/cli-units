...
public class SubinterfaceStatisticsConfigWriter implements CliWriter<Config> {
    private Cli cli;
    ...
    public SubinterfaceStatisticsConfigWriter(Cli cli) {
        this.cli = cli;
    }
    ...
    public void writeCurrentAttributes(
        ...
        Preconditions.checkArgument(subId != AbstractSubinterfaceReader.ZERO_SUBINTERFACE_ID,
            "Statistics configuration can not be set to ZERO subinterface.");
