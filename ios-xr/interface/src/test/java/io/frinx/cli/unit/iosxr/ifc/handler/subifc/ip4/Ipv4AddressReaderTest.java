...
class Ipv4AddressReaderTest {
    ...
    void testparseAddressConfig() {
        assertEquals(EXPECTED, reader.parseAddressIds(OUTPUT));
        assertTrue(reader.parseAddressIds(EMPTY_OUTPUT).isEmpty());
    }
    ...
    void testGetAllIds() throws ReadFailedException {
        ...
        assertThat(result.get(0), CoreMatchers.equalTo(IPADDRESS_KEY));
    }

    @Test
    void testGetAllIdsZero() throws ReadFailedException {
    ...
    void testReadCurrentAttributes() throws ReadFailedException {
        ...
        assertThat(builder.getIp(), CoreMatchers.sameInstance(IPADDRESS));
    }

    @Test
    void testReadCurrentAttributesZero() throws ReadFailedException {
        final AddressBuilder builder = new AddressBuilder();
