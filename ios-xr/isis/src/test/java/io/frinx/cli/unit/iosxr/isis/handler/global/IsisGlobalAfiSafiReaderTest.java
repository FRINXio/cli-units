...
class IsisGlobalAfiSafiReaderTest {
    ...
    void testReadCurrentAttributes() throws ReadFailedException {
        ...
        assertThat(builder.getAfiName(), CoreMatchers.equalTo(IPV4.class));
        assertThat(builder.getSafiName(), CoreMatchers.equalTo(UNICAST.class));
    }
}
