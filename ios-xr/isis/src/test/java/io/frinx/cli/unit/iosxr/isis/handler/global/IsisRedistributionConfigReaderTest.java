...
class IsisRedistributionConfigReaderTest {
    ...
    private static final String SH_RUN_ROUTER_ISIS_LINES = """
            router isis ISIS-001
    ...
    void testReadCurrentAttributes() throws ReadFailedException {
        ...
        assertThat(builder.getLevel(), CoreMatchers.equalTo(LevelType.LEVEL1));
        assertThat(builder.getMetric(), CoreMatchers.equalTo(10L));
        assertThat(builder.getRoutePolicy(), CoreMatchers.equalTo("POLICY-001"));
    }
}
