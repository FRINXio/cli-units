...
package io.frinx.cli.iosxr.isis.handler;
...
public class IsisProtocolReaderTest {
    ...
    public void testGetAllIds_001() throws ReadFailedException {
        ...
        Assert.assertThat(result.get(0).getName(), CoreMatchers.equalTo(INSTANCE_NAME));
        Assert.assertThat(result.get(0).getIdentifier(), CoreMatchers.equalTo(ISIS.class));
    }
    ...
    public void testReadCurrentAttributes() {
        ...
        Assert.assertThat(builder.getName(), CoreMatchers.equalTo(INSTANCE_NAME));
        Assert.assertThat(builder.getIdentifier(), CoreMatchers.equalTo(ISIS.class));
    }
}
