...
class InterfaceReaderTest {
    ...
    void testParseAllInterfaceIds() {
        assertEquals(EXPECTED_ALL_IDS, new InterfaceReader(Mockito.mock(Cli.class))
                .parseAllInterfaceIds(SH_RUN_INT));
    }

    @Test
    void testParseInterfaceIds() {
        assertEquals(EXPECTED_IDS, new InterfaceReader(Mockito.mock(Cli.class)).parseInterfaceIds(SH_RUN_INT));
    }
