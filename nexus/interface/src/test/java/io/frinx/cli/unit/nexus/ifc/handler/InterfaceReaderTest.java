...
public class InterfaceReaderTest {
    ...
    private static List<InterfaceKey> EXPECTED_ALL_IDS =
            Lists.newArrayList("Loopback97", "Loopback98", "Loopback99", "Loopback101", "Loopback199",
                    ...
                    "Port-Channel97",
                    "Port-Channel98", "Port-Channel99", "Port-Channel101")
                    .stream()
    ...
    private static List<InterfaceKey> EXPECTED_IDS =
            Lists.newArrayList("Loopback97", "Loopback98", "Loopback99", "Loopback101", "Loopback199",
                    ...
                    "GigabitEthernet0/0/0/3", "GigabitEthernet0/0/0/5", "Port-Channel97", "Port-Channel98",
                    "Port-Channel99",
                    "Port-Channel101")
                    .stream()
                    .map(InterfaceKey::new)
    ...
    public void testParseAllInterfaceIds() {
        Assert.assertEquals(EXPECTED_ALL_IDS, new InterfaceReader(Mockito.mock(Cli.class))
                .parseAllInterfaceIds(SH_RUN_INT));
    }

    @Test
    public void testParseInterfaceIds() {
        Assert.assertEquals(EXPECTED_IDS, new InterfaceReader(Mockito.mock(Cli.class)).parseInterfaceIds(SH_RUN_INT));
    }
