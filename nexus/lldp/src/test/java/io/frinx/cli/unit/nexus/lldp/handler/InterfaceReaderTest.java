...
public class InterfaceReaderTest {
    ...
    private static final String SH_LLDP_INTERFACE_OUTPUT = """
        ...
        Interface Information: Eth1/9 Enable (tx/rx/dcbx): Y/Y/Y   \s
        Interface Information: Eth1/8 Enable (tx/rx/dcbx): Y/Y/Y   \s
        Interface Information: Eth1/7 Enable (tx/rx/dcbx): Y/Y/Y   \s
        Interface Information: Eth1/6 Enable (tx/rx/dcbx): Y/Y/Y   \s
        Interface Information: Eth1/5 Enable (tx/rx/dcbx): Y/Y/Y   \s
        Interface Information: Eth1/4 Enable (tx/rx/dcbx): Y/Y/Y   \s
        Interface Information: Eth1/3 Enable (tx/rx/dcbx): Y/Y/Y   \s
        Interface Information: Eth1/2 Enable (tx/rx/dcbx): Y/Y/Y   \s
        Interface Information: Eth1/1 Enable (tx/rx/dcbx): Y/Y/Y   \s
        Interface Information: mgmt0 Enable (tx/rx/dcbx): Y/Y/N   \s
        """;
