...
public class IngressAclSetConfigWriter implements CliWriter<Config> {
    ...
    public void writeCurrentAttributes(@Nonnull InstanceIdentifier<Config> instanceIdentifier,
        ...
        blockingWriteAndRead(cli, instanceIdentifier, config,
                ...
                f("apply access-list %s %s in", AclUtil.chooseIpCommand(aclType), config.getSetName()),
                "end");
    }
    ...
    public void deleteCurrentAttributes(@Nonnull InstanceIdentifier<Config> instanceIdentifier,
        ...
        blockingWriteAndRead(cli, instanceIdentifier, config,
                "configure\n",
                f("interface %s", name),
                f("no apply access-list %s %s in", AclUtil.chooseIpCommand(aclType), config.getSetName()),
                "end");
    }
    ...
    private void checkIngressAclSetConfigExists(final InstanceIdentifier<Config> instanceIdentifier,
        ...
        // find multiple ingress acl sets for type ipv4
