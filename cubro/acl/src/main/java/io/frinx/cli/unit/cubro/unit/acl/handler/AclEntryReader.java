...
public class AclEntryReader {
    ...
    List<AclEntryKey> getAllIds(@NotNull final InstanceIdentifier<AclSet> instanceIdentifier,
    ...
    void readCurrentAttributes(@NotNull final InstanceIdentifier<AclSet> instanceIdentifier,
                                      @NotNull final AclEntryBuilder aclEntryBuilder,
                                      @NotNull final ReadContext readContext) throws ReadFailedException {
