...
public class CfmMipReader implements CliConfigListReader<Level, LevelKey, LevelBuilder> {
    ...
    @Nonnull
    @Override
    public List<LevelKey> getAllIds(@Nonnull InstanceIdentifier<Level> id,
    ...
    @Override
    public void readCurrentAttributes(@Nonnull InstanceIdentifier<Level> id,
                                      @Nonnull LevelBuilder builder,
                                      @Nonnull ReadContext ctx) throws ReadFailedException {
    ...
    @VisibleForTesting
    void parseLevelMip(Short level, String ifcOutput, LevelBuilder builder) {
