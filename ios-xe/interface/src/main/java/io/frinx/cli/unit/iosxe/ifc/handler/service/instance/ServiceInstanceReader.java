...
public final class ServiceInstanceReader
    ...
    @NotNull
    @Override
    public List<ServiceInstanceKey> getAllIds(@NotNull InstanceIdentifier<ServiceInstance> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<ServiceInstance> instanceIdentifier,
                                      @NotNull ServiceInstanceBuilder serviceInstanceBuilder,
                                      @NotNull ReadContext readContext) throws ReadFailedException {
