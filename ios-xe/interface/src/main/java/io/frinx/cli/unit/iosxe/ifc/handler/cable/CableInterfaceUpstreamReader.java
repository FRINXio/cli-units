...
public class CableInterfaceUpstreamReader implements
    ...
    @NotNull
    @Override
    public List<UpstreamCablesKey> getAllIds(@NotNull InstanceIdentifier<UpstreamCables> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<UpstreamCables> instanceIdentifier,
                                      @NotNull UpstreamCablesBuilder upstreamCablesBuilder,
                                      @NotNull ReadContext readContext) throws ReadFailedException {
