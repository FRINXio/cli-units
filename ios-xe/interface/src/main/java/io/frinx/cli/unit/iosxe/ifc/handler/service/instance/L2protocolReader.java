...
public class L2protocolReader implements CliConfigListReader<L2protocol, L2protocolKey, L2protocolBuilder> {
    ...
    @NotNull
    @Override
    public List<L2protocolKey> getAllIds(@NotNull InstanceIdentifier<L2protocol> instanceIdentifier,
    ...
    @VisibleForTesting
    static List<L2protocolKey> parseL2protocolNames(@NotNull String aclNameConfiguration) {
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<L2protocol> instanceIdentifier,
                                      @NotNull L2protocolBuilder l2protocolBuilder, @NotNull ReadContext readContext)
