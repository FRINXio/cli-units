...
public final class InterfaceStatisticsConfigReader implements CliConfigReader<Config, ConfigBuilder> {

    private static final Pattern LOAD_INTERVAL = Pattern.compile("load-interval (?<loadInterval>\\d+)");
    ...
    public static void parseLoadInterval(final String output, final ConfigBuilder builder) {
