...
public class CableUpstreamReader implements CliConfigListReader<BondingGroup, BondingGroupKey, BondingGroupBuilder> {
    ...
    @NotNull
    @Override
    public List<BondingGroupKey> getAllIds(@NotNull InstanceIdentifier<BondingGroup> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<BondingGroup> instanceIdentifier,
                                      @NotNull BondingGroupBuilder bondingGroupBuilder,
                                      @NotNull ReadContext readContext) throws ReadFailedException {
