...
public class Ipv6ConfigReaderTest {
    ...
    private static final String IP = "2002::1";
    private static final Config EXPECTED = new ConfigBuilder()
            .setIp(new Ipv6AddressNoZone(IP))
    ...
    public void testParse() {
        ...
        new Ipv6ConfigReader(Mockito.mock(Cli.class))
                .parseAddressConfig(builder, Ipv6AddressReaderTest.OUTPUT, new Ipv6AddressNoZone(IP));
