...
class CableInterfaceDownstreamConfigReaderTest {

    static final String OUTPUT = """
             downstream Integrated-Cable 1/0/0 rf-channel 0
    ...
    void test() {
        ...
        assertEquals("Integrated-Cable1/0/0", builder.getName());
        assertEquals("0 2 8 10", builder.getRfChannels());
    }
}
