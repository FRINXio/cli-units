...
public class BfdTemplateReader implements CliConfigListReader<BfdTemplate, BfdTemplateKey, BfdTemplateBuilder> {
    ...
    @NotNull
    @Override
    public List<BfdTemplateKey> getAllIds(@NotNull InstanceIdentifier<BfdTemplate> instanceIdentifier,
                                        @NotNull ReadContext readContext) throws ReadFailedException {
        return parseBfdTemplateNames(blockingRead(SH_RUN_BFD_TEMPLATE, cli, instanceIdentifier, readContext));
    }

    @VisibleForTesting
    static List<BfdTemplateKey> parseBfdTemplateNames(@NotNull String bfdTemplatesConfiguration) {
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<BfdTemplate> instanceIdentifier,
                                      @NotNull BfdTemplateBuilder bfdTempAugBuilder, @NotNull ReadContext readContext)
