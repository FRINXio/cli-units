...
public class BfdTemplateConfigWriter implements CliWriter<BfdTempAug> {
    ...
    @Override
    public void writeCurrentAttributes(@Nonnull InstanceIdentifier<BfdTempAug> instanceIdentifier,
                                       @Nonnull BfdTempAug bfdTempAug,
    ...
    @Override
    public void updateCurrentAttributes(@Nonnull InstanceIdentifier<BfdTempAug> instanceIdentifier,
                                        @Nonnull BfdTempAug dataBefore,
                                        @Nonnull BfdTempAug dataAfter,
                                        @Nonnull WriteContext writeContext) throws WriteFailedException {
    ...
    @Override
    public void deleteCurrentAttributes(@Nonnull InstanceIdentifier<BfdTempAug> instanceIdentifier,
                                        @Nonnull BfdTempAug bfdTempAug,
                                        @Nonnull WriteContext writeContext) throws WriteFailedException {
        blockingWriteAndRead(cli, instanceIdentifier, bfdTempAug,
                fT(TEMPLATE,
