...
package io.frinx.cli.unit.iosxe.network.instance.handler.vrf.table;

import io.frinx.cli.io.Cli;
import io.frinx.cli.unit.iosxe.bgp.handler.table.BgpTableConnectionReader;
...
public class TableConnectionReader
    ...
    public TableConnectionReader(Cli cli) {
        super(List.of(new BgpTableConnectionReader(cli)));
    }
