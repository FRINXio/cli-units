...
import io.frinx.cli.unit.iosxe.network.instance.handler.l2vsi.cp.L2VSIConnectionPointsReader;
...
public class ConnectionPointsReader extends CompositeReader<ConnectionPoints, ConnectionPointsBuilder>
    ...
    public ConnectionPointsReader(Cli cli) {
        super(List.of(
            new L2P2PConnectionPointsReader(cli),
            new L2VSIConnectionPointsReader(cli)));
    }
