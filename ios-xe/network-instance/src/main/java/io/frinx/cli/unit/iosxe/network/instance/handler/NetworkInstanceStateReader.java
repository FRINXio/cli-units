...
package io.frinx.cli.unit.iosxe.network.instance.handler;

import io.frinx.cli.io.Cli;
import io.frinx.cli.unit.handlers.def.DefaultStateReader;
import io.frinx.cli.unit.iosxe.network.instance.handler.l2p2p.L2P2PStateReader;
import io.frinx.cli.unit.iosxe.network.instance.handler.l2vsi.L2VSIStateReader;
import io.frinx.cli.unit.iosxe.network.instance.handler.vrf.VrfStateReader;
...
public final class NetworkInstanceStateReader extends CompositeReader<State, StateBuilder>
    ...
    public NetworkInstanceStateReader(Cli cli) {
        super(List.of(
                new VrfStateReader(cli),
                new DefaultStateReader(),
                new L2P2PStateReader(cli),
                new L2VSIStateReader(cli)
        ));
    }
}
