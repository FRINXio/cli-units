...
package io.frinx.cli.unit.iosxe.network.instance.handler.forwarding;
...
public class PolicyForwardingInterfaceReader implements CliConfigListReader<Interface, InterfaceKey, InterfaceBuilder> {
    ...
    private static final String SH_SERVICE_POLICY_INT =
            "show running-config | include ^interface |^ service-policy input|^ service-policy output";
    ...
    @NotNull
    @Override
    public List<InterfaceKey> getAllIds(@NotNull InstanceIdentifier<Interface> id, @NotNull ReadContext context)
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Interface> id, @NotNull InterfaceBuilder builder,
