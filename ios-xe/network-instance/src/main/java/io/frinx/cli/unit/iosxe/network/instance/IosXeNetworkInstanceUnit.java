...
package io.frinx.cli.unit.iosxe.network.instance;
...
import io.frinx.cli.unit.iosxe.network.instance.handler.ConnectionPointsReader;
import io.frinx.cli.unit.iosxe.network.instance.handler.ConnectionPointsWriter;
import io.frinx.cli.unit.iosxe.network.instance.handler.NetworkInstanceConfigReader;
import io.frinx.cli.unit.iosxe.network.instance.handler.NetworkInstanceConfigWriter;
import io.frinx.cli.unit.iosxe.network.instance.handler.NetworkInstanceReader;
import io.frinx.cli.unit.iosxe.network.instance.handler.NetworkInstanceStateReader;
import io.frinx.cli.unit.iosxe.network.instance.handler.forwarding.PolicyForwardingInterfaceConfigReader;
import io.frinx.cli.unit.iosxe.network.instance.handler.forwarding.PolicyForwardingInterfaceConfigWriter;
import io.frinx.cli.unit.iosxe.network.instance.handler.forwarding.PolicyForwardingInterfaceReader;
import io.frinx.cli.unit.iosxe.network.instance.handler.vlan.VlanConfigReader;
import io.frinx.cli.unit.iosxe.network.instance.handler.vlan.VlanConfigWriter;
import io.frinx.cli.unit.iosxe.network.instance.handler.vlan.VlanReader;
import io.frinx.cli.unit.iosxe.network.instance.handler.vrf.ifc.VrfInterfaceReader;
import io.frinx.cli.unit.iosxe.network.instance.handler.vrf.ifc.VrfInterfaceWriter;
import io.frinx.cli.unit.iosxe.network.instance.handler.vrf.protocol.ProtocolConfigReader;
import io.frinx.cli.unit.iosxe.network.instance.handler.vrf.protocol.ProtocolConfigWriter;
import io.frinx.cli.unit.iosxe.network.instance.handler.vrf.protocol.ProtocolReader;
import io.frinx.cli.unit.iosxe.network.instance.handler.vrf.protocol.ProtocolStateReader;
import io.frinx.cli.unit.iosxe.network.instance.handler.vrf.table.TableConnectionConfigWriter;
import io.frinx.cli.unit.iosxe.network.instance.handler.vrf.table.TableConnectionReader;
...
public class IosXeNetworkInstanceUnit extends AbstractUnit {

    public IosXeNetworkInstanceUnit(@Nonnull final TranslationUnitCollector registry) {
        super(registry);
    }
    ...
    private void provideWriters(CustomizerAwareWriteRegistryBuilder writeRegistry, Cli cli) {
        ...
        writeRegistry.subtreeAddAfter(IIDs.NE_NE_CONNECTIONPOINTS,
                ...
                //handle after network instance configuration
                        IIDs.NE_NE_CONFIG);
