...
import org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.evc.rev210507.evc.top.evcs.Evc;
import org.opendaylight.yang.gen.v1.http.frinx.openconfig.net.yang.evc.rev210507.evc.top.evcs.EvcBuilder;
...
public class EvcReader implements CliConfigListReader<Evc, EvcKey, EvcBuilder> {
    ...
    @Nonnull
    @Override
    public List<EvcKey> getAllIds(@Nonnull InstanceIdentifier<Evc> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@Nonnull InstanceIdentifier<Evc> instanceIdentifier,
                                      @Nonnull EvcBuilder evcBuilder,
                                      @Nonnull ReadContext readContext) throws ReadFailedException {
