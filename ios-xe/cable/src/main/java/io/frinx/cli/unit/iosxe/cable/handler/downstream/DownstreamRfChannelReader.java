...
public class DownstreamRfChannelReader implements CliConfigListReader<RfChannel, RfChannelKey, RfChannelBuilder> {
    ...
    @NotNull
    @Override
    public List<RfChannelKey> getAllIds(@NotNull InstanceIdentifier<RfChannel> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<RfChannel> instanceIdentifier,
                                      @NotNull RfChannelBuilder rfChannelBuilder,
