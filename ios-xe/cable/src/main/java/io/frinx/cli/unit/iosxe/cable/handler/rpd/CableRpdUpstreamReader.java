...
public class CableRpdUpstreamReader implements
    ...
    @Nonnull
    @Override
    public List<UpstreamCommandsKey> getAllIds(@Nonnull InstanceIdentifier<UpstreamCommands> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@Nonnull InstanceIdentifier<UpstreamCommands> instanceIdentifier,
                                      @Nonnull UpstreamCommandsBuilder upstreamCommandsBuilder,
