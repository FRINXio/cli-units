...
public class CableRpdDownstreamReader implements
    ...
    @NotNull
    @Override
    public List<DownstreamCommandsKey> getAllIds(@NotNull InstanceIdentifier<DownstreamCommands> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<DownstreamCommands> instanceIdentifier,
                                      @NotNull DownstreamCommandsBuilder downstreamCommandsBuilder,
