...
public class CableChannelReader implements CliConfigListReader<CableChannel, CableChannelKey, CableChannelBuilder> {
    ...
    @NotNull
    @Override
    public List<CableChannelKey> getAllIds(@NotNull InstanceIdentifier<CableChannel> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<CableChannel> instanceIdentifier,
                                      @NotNull CableChannelBuilder cableChannelBuilder,
