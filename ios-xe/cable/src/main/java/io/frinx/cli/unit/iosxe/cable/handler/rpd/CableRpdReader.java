...
public class CableRpdReader implements CliConfigListReader<Rpd, RpdKey, RpdBuilder> {
    ...
    @NotNull
    @Override
    public List<RpdKey> getAllIds(@NotNull InstanceIdentifier<Rpd> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Rpd> instanceIdentifier,
                                      @NotNull RpdBuilder rpdBuilder,
