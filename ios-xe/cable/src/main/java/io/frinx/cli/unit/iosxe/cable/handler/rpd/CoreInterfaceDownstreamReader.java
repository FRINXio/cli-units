...
public class CoreInterfaceDownstreamReader implements
    ...
    @Nonnull
    @Override
    public List<DownstreamPortsKey> getAllIds(@Nonnull InstanceIdentifier<DownstreamPorts> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@Nonnull InstanceIdentifier<DownstreamPorts> instanceIdentifier,
                                      @Nonnull DownstreamPortsBuilder downstreamPortsBuilder,
