...
public class CoreInterfaceUpstreamReader implements
    ...
    @Nonnull
    @Override
    public List<UpstreamPortsKey> getAllIds(@Nonnull InstanceIdentifier<UpstreamPorts> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@Nonnull InstanceIdentifier<UpstreamPorts> instanceIdentifier,
                                      @Nonnull UpstreamPortsBuilder upstreamPortsBuilder,
