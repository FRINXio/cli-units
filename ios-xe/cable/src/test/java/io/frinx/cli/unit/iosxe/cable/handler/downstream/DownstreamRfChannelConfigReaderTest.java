...
public class DownstreamRfChannelConfigReaderTest {
    ...
    public void testDownstreamConfig() {
        ...
        Assert.assertEquals("602000000",configBuilder.getFrequency());
        Assert.assertEquals("3",configBuilder.getQamProfile());
        Assert.assertEquals("1",configBuilder.getDocsisChannelId());
        Assert.assertEquals(RfOutput.Normal, configBuilder.getRfOutput());
    }
