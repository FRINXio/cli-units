...
public class CableRpdUpstreamConfigWriterTest {
    ...
    private static final String UPDATE_INPUT = "configure terminal\n"
            + "cable rpd VFZ-RPD-100\n"
            + "no rpd-us 0 description\n"
            + "rpd-us 0 description HST-WC0001-DAA001B\n"
            + "end\n";
    ...
    private static final Config CONFIG_WRITE = new ConfigBuilder()
            .setId("0")
            .setDescription("HST-WC0001-DAA001A")
            .build();

    private static final Config CONFIG_UPDATE = new ConfigBuilder()
            .setId("0")
            .setDescription("HST-WC0001-DAA001B")
            .build();
    ...
    private CableRpdUpstreamConfigWriter writer;
    ...
    public void setup() {
        ...
        writer = new CableRpdUpstreamConfigWriter(cli);
    }
