...
public class RfChannelTypeConfigReaderTest {
    ...
    public void testCoreInterface() {
        ...
        Assert.assertEquals(Mode.Async, configBuilder.getMode());
        Assert.assertEquals(RfType.Video, configBuilder.getRfType());
    }
