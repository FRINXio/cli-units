...
import io.frinx.cli.unit.iosxe.bgp.handler.GlobalAfiSafiConfigReader;
import io.frinx.cli.unit.iosxe.bgp.handler.GlobalAfiSafiConfigWriter;
import io.frinx.cli.unit.iosxe.bgp.handler.GlobalAfiSafiReader;
...
import io.frinx.cli.unit.iosxe.bgp.handler.local.aggregates.BgpLocalAggregateConfigReader;
import io.frinx.cli.unit.iosxe.bgp.handler.local.aggregates.BgpLocalAggregateConfigWriter;
import io.frinx.cli.unit.iosxe.bgp.handler.local.aggregates.BgpLocalAggregateReader;
import io.frinx.cli.unit.iosxe.bgp.handler.neighbor.NeighborAfiSafiPolicyConfigReader;
import io.frinx.cli.unit.iosxe.bgp.handler.neighbor.NeighborAfiSafiReader;
import io.frinx.cli.unit.iosxe.bgp.handler.neighbor.NeighborConfigReader;
import io.frinx.cli.unit.iosxe.bgp.handler.neighbor.NeighborPolicyConfigReader;
import io.frinx.cli.unit.iosxe.bgp.handler.neighbor.NeighborReader;
import io.frinx.cli.unit.iosxe.bgp.handler.neighbor.NeighborRouteReflectorConfigReader;
import io.frinx.cli.unit.iosxe.bgp.handler.neighbor.NeighborStateReader;
import io.frinx.cli.unit.iosxe.bgp.handler.neighbor.NeighborTimersConfigReader;
...
import io.frinx.cli.unit.iosxe.bgp.handler.neighbor.PrefixesReader;
import io.frinx.cli.unit.iosxe.bgp.handler.peergroup.PeerGroupAfiSafiPolicyConfigReader;
import io.frinx.cli.unit.iosxe.bgp.handler.peergroup.PeerGroupAfiSafiReader;
import io.frinx.cli.unit.iosxe.bgp.handler.peergroup.PeerGroupConfigReader;
import io.frinx.cli.unit.iosxe.bgp.handler.peergroup.PeerGroupPolicyConfigReader;
import io.frinx.cli.unit.iosxe.bgp.handler.peergroup.PeerGroupReader;
import io.frinx.cli.unit.iosxe.bgp.handler.peergroup.PeerGroupRouteReflectorConfigReader;
import io.frinx.cli.unit.iosxe.bgp.handler.peergroup.PeerGroupTransportConfigReader;
import io.frinx.cli.unit.iosxe.bgp.handler.peergroup.PeerGroupWriter;
...
public class BgpUnit extends AbstractUnit {
    ...
    public BgpUnit(@NotNull final TranslationUnitCollector registry) {
        super(registry);
    }
    ...
    protected String getUnitName() {
        return "IOS XE BGP (Openconfig) translate unit";
    }
    ...
    private void provideNeighborReaders(@NotNull CustomizerAwareReadRegistryBuilder readRegistry, Cli cli) {
    ...
    private void providePeerGroupReaders(@NotNull CustomizerAwareReadRegistryBuilder readRegistry, Cli cli) {
