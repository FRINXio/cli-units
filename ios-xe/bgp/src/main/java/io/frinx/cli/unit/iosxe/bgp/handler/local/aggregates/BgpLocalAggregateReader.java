...
public class BgpLocalAggregateReader implements CliConfigListReader<Aggregate, AggregateKey, AggregateBuilder> {
    ...
    @NotNull
    @Override
    public List<AggregateKey> getAllIds(@NotNull InstanceIdentifier<Aggregate> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Aggregate> instanceIdentifier,
                                      @NotNull AggregateBuilder aggregateBuilder, @NotNull ReadContext
