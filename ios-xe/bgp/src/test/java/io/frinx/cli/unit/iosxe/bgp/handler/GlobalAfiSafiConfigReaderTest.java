...
class GlobalAfiSafiConfigReaderTest {
    ...
    void parseConfigTest() {
        ...
        buildAndTest("default", IPV4UNICAST.class, false, null, null, null, null, null, null, null);

        // VLAN372638 network instance
        buildAndTest("VLAN372638", IPV4UNICAST.class, null, true, "FOO", true, "BAR", true, true, "FOO");

        // CIA-SINGLE network instance
        buildAndTest("CIA-SINGLE", IPV4UNICAST.class, null, false, null, false, null, false, false, null);

        // CIA-SINGLE1 network instance
        buildAndTest("CIA-SINGLE1", IPV4UNICAST.class, null, false, null, true, null, false, true, "BAR");
    }
    ...
    private void buildAndTest(String vrfKey,
        ...
        assertEquals(expectedTableMap, configAug.getTableMap());
    }
}
