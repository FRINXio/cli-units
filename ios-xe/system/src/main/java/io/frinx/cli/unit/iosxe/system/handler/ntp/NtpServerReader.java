...
public class NtpServerReader implements CliConfigListReader<Server, ServerKey, ServerBuilder> {
    ...
    @Nonnull
    @Override
    public List<ServerKey> getAllIds(@Nonnull InstanceIdentifier<Server> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@Nonnull InstanceIdentifier<Server> instanceIdentifier,
                                      @Nonnull ServerBuilder builder,
