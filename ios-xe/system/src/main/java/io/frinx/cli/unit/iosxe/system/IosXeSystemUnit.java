...
import io.frinx.cli.unit.iosxe.system.handler.license.LicenseReader;
import io.frinx.cli.unit.iosxe.system.handler.license.LicenseStateReader;
...
public class IosXeSystemUnit extends AbstractUnit {
    public IosXeSystemUnit(@NotNull final TranslationUnitCollector translationRegistry) {
    ...
    public Set<YangModuleInfo> getYangSchemas() {
        return Sets.newHashSet(IIDs.FRINX_OPENCONFIG_SYSTEM,
                ...
                IIDs.FRINX_OPENCONFIG_LICENSE,
                IIDs.FRINX_CISCO_LICENSE_EXTENSION);
    }
    ...
    private void provideReaders(CustomizerAwareReadRegistryBuilder readRegistry, Cli cli) {
        ...
        readRegistry.add(IIDs.LI_LICENSE, new LicenseReader(cli));
        readRegistry.add(IIDs.LI_LI_STATE, new LicenseStateReader(cli));
    }
}