...
public class NtpAccessGroupConfigWriterTest {
    ...
    private static final String DELETE_INPUT = "configure terminal\n"
            ...
            + "no ntp access-group serve-only\n"
    ...
    private NtpAccessGroupConfigWriter writer;
    ...
    public void setup() {
        ...
        writer = new NtpAccessGroupConfigWriter(cli);
    }
