...
public class ComponentReader implements CliOperListReader<Component, ComponentKey, ComponentBuilder> {
    ...
    @Override
    public void merge(@NotNull Builder<? extends DataObject> builder, @NotNull List<Component> config) {
    ...
    @NotNull
    @Override
    public List<ComponentKey> getAllIds(@NotNull InstanceIdentifier<Component> id, @NotNull ReadContext context)
