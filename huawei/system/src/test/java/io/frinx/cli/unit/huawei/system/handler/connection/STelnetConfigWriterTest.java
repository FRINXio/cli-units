...
public class STelnetConfigWriterTest {
    ...
    private STelnetConfigWriter writer;
    ...
    private final InstanceIdentifier<Config> iid = IIDs.SY_AUG_STELNETHUAWEIAUG_ST_CONFIG;
    ...
    public void setUp() {
        ...
        writer = new STelnetConfigWriter(cli);
    }
