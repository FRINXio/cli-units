...
class ClockDaylightSavingTimeConfigWriterTest {
    ...
    private static final String WRITE_CONFIG_DATA_ONE_YEAR = """
            clock daylight-saving-time TEST one-year 02:00 2022-03-27 03:00 2022-10-30 01:00
            return
            """;

    private static final String UPDATE_CONFIG_DATA_ONE_YEAR = """
            clock daylight-saving-time TEST one-year 02:00 2022-03-31 03:00 2022-10-31 01:00
            return
            """;

    private static final String WRITE_CONFIG_DATA_REPEATING_1 = """
            clock daylight-saving-time CEST repeating 02:00 last Sun Mar 03:00 last Sun Oct 01:00 2018 2025
            return
            """;

    private static final String UPDATE_CONFIG_DATA_REPEATING_1 = """
            clock daylight-saving-time TEST repeating 02:00 03-31 03:00 10-31 01:00 2020 2025
            return
            """;

    private static final String WRITE_CONFIG_DATA_REPEATING_2 = """
            clock daylight-saving-time TEST repeating 02:00 last Sun Mar 03:00 10-31 01:00 2020 2025
            return
            """;

    private static final String UPDATE_CONFIG_DATA_REPEATING_2 = """
            clock daylight-saving-time TEST repeating 02:00 03-31 03:00 last Sun Oct 01:00 2020 2025
            return
            """;
    ...
    @Test
    void testWriteOneYear() throws Exception {
    ...
    @Test
    void testUpdateOneYear() throws Exception {
    ...
    @Test
    void testWriteRepeating1() throws Exception {
    ...
    @Test
    void testUpdateRepeating1() throws Exception {
    ...
    @Test
    void testWriteRepeating2() throws Exception {
    ...
    @Test
    void testUpdateRepeating2() throws Exception {
