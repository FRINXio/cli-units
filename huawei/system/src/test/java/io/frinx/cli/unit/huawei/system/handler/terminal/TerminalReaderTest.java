...
public class TerminalReaderTest {
    ...
    @Test
    public void testTerminalIds() {
        List<TerminalKey> keys = TerminalReader.getAllIds(outputTerminals);
        Assert.assertEquals(keys, Arrays.asList(new TerminalKey("con"), new TerminalKey("vty")));
    }
}