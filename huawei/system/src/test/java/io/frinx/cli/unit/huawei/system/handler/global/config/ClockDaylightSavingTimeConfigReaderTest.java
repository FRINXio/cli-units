...
class ClockDaylightSavingTimeConfigReaderTest {

    private static final String CLOCK_OUTPUT_ONE_YEAR = """
             clock timezone CET add 01:00:00\r
             clock daylight-saving-time TEST one-year 12:30 2022-3-27 13:30 2022-10-30 01:00\r
            """;

    private static final String CLOCK_OUTPUT_ONE_YEAR_2 = """
             clock timezone CET add 01:00:00\r
             clock daylight-saving-time TEST one-year 2:0 2022-3-27 3:0 2022-10-30 01:00\r
            """;

    private static final String CLOCK_OUTPUT_REPEATING_DAY = """
             clock timezone CET add 01:00:00\r
             clock daylight-saving-time CEST repeating 2:0 last Sunday March 3:0 last Sunday October 01:00 2018 2025\r
            """;

    private static final String CLOCK_OUTPUT_REPEATING_DATE = """
             clock timezone CET add 01:00:00\r
             clock daylight-saving-time TEST repeating 2:0 3-31 3:0 10-31 01:00 2020 2025\r
            """;

    private static final String CLOCK_OUTPUT_REPEATING_COMBINATION_1 = """
             clock timezone CET add 01:00:00\r
             clock daylight-saving-time TEST repeating 2:0 3-31 3:0 last Sunday October 01:00 2020 2025\r
            """;

    private static final String CLOCK_OUTPUT_REPEATING_COMBINATION_2 = """
             clock timezone CET add 01:00:00\r
             clock daylight-saving-time TEST repeating 2:0 last Sunday March 3:0 10-31 01:00 2020 2025\r
            """;

    @Test
    void parseConfigOneYearTest() {
        ...
        Config expected = new ConfigBuilder()
                ...
                .build();
        assertEquals(expected, confiBuilder.build());
    }

    @Test
    void parseConfigOneYearNonLeadingZeroTest() {
    ...
    @Test
    void parseConfigRepeatingDayTest() {
        ConfigBuilder configBuilder = new ConfigBuilder();
    ...
    @Test
    void parseConfigRepeatingDateTest() {
        ConfigBuilder configBuilder = new ConfigBuilder();
    ...
    @Test
    void parseConfigRepeatingConbination1Test() {
        ConfigBuilder configBuilder = new ConfigBuilder();
    ...
    @Test
    void parseConfigRepeatingCombination2Test() {
        ConfigBuilder configBuilder = new ConfigBuilder();
