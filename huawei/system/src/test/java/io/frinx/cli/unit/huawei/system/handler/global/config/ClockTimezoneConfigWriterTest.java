...
class ClockTimezoneConfigWriterTest {
    ...
    private static final String WRITE_CONFIG_DATA = """
            clock timezone CET add 01:00:00
            return
            """;

    private static final String UPDATE_CONFIG_DATA = """
            clock timezone TEST minus 01:00:00
            return
            """;
