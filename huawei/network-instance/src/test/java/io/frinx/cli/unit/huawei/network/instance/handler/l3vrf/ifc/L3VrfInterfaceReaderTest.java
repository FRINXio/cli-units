...
public class L3VrfInterfaceReaderTest {
    ...
    private static final String DISPLAY_VPN_INTERFACES = "Info: It will take a long time if the content you search is"
            + " too much or the string you input is too long, you can press CTRL_C to break.\r\n"
