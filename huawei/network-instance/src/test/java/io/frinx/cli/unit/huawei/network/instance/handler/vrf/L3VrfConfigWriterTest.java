...
public class L3VrfConfigWriterTest {
    ...
    private static final String WRITE_WITHOUT_RD_INPUT = "system-view\n"
            + "ip vpn-instance 3940\n"
            + "undo ipv4-family\n"
            + "commit\n"
            + "return\n";

    private static final String WRITE_WITHOUT_AUG_INPUT = "system-view\n"
            + "ip vpn-instance 3940\n"
            + "ipv4-family\n"
    ...
    private static final String WRITE_WITH_AUG_INPUT = "system-view\n"
            + "ip vpn-instance 3940\n"
            + "ipv4-family\n"
            + "route-distinguisher 2:2\n"
            + "prefix limit 100 80\n"
    ...
    private static final String UPDATE_WITHOUT_AUG_INPUT = "system-view\n"
            + "ip vpn-instance 3940\n"
            + "undo ipv4-family\n"
            + "ipv4-family\n"
            + "route-distinguisher 2:2\n"
    ...
    private static final String UPDATE_WITHOUT_RD_INPUT = "system-view\n"
            + "ip vpn-instance 3940\n"
            + "undo ipv4-family\n"
            + "commit\n"
            + "return\n";

    private static final String UPDATE_WITH_ALL_INPUT = "system-view\n"
            + "ip vpn-instance 3940\n"
            + "undo ipv4-family\n"
            + "ipv4-family\n"
            + "route-distinguisher 2:2\n"
    ...
    @Test
    public void testWriteWithoutRD() throws Exception {
    ...
    @Test
    public void testWriteWithoutAug() throws Exception {
    ...
    @Test
    public void testWriteWithAug() throws Exception {
    ...
    @Test
    public void testUpdateWithoutAug() throws Exception {
    ...
    @Test
    public void testUpdateWithoutRD() throws Exception {
    ...
    @Test
    public void testUpdateWithAllIds() throws Exception {
