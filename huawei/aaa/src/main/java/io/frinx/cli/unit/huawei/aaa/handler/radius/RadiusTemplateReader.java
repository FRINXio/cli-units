...
public final class RadiusTemplateReader implements CliConfigListReader<Template, TemplateKey, TemplateBuilder> {
    ...
    @NotNull
    @Override
    public List<TemplateKey> getAllIds(@NotNull InstanceIdentifier<Template> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Template> instanceIdentifier,
