...
public final class AccountingSchemasReader implements CliConfigListReader<Account, AccountKey, AccountBuilder> {
    ...
    @NotNull
    @Override
    public List<AccountKey> getAllIds(@NotNull InstanceIdentifier<Account> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Account> instanceIdentifier,
                                      @NotNull AccountBuilder builder,
