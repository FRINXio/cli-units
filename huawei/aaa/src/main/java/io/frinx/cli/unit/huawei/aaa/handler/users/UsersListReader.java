...
public final class UsersListReader implements CliConfigListReader<User, UserKey, UserBuilder> {
    ...
    @Nonnull
    @Override
    public List<UserKey> getAllIds(@Nonnull InstanceIdentifier<User> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@Nonnull InstanceIdentifier<User> instanceIdentifier,
                                      @Nonnull UserBuilder builder,
