...
public final class AuthenticationSchemasReader implements CliConfigListReader<Authentication,
    ...
    @NotNull
    @Override
    public List<AuthenticationKey> getAllIds(@NotNull InstanceIdentifier<Authentication> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Authentication> instanceIdentifier,
                                      @NotNull AuthenticationBuilder builder,
