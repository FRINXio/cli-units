...
public final class DomainListReader implements CliConfigListReader<Domain, DomainKey, DomainBuilder> {
    ...
    @NotNull
    @Override
    public List<DomainKey> getAllIds(@NotNull InstanceIdentifier<Domain> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Domain> instanceIdentifier,
