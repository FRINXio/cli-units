...
class AuthenticationSchemasConfigReaderTest {
    ...
    @Test
    void testAuthenticationIdsWithConfig() {
        ConfigBuilder configBuilder = new ConfigBuilder();
        AuthenticationSchemasConfigReader.parseConfigAttributes(outputAuthenticationConfig, configBuilder, "radius");
        assertEquals(new ConfigBuilder().setAuthentication(new AuthenticationBuilder().setConfig(
    ...
    @Test
    void testAuthenticationIdsWithoutConfig() {
        ConfigBuilder configBuilder = new ConfigBuilder();
    ...
    @Test
    void testAuthenticationIdsWithAnotherConfig() {
        ConfigBuilder configBuilder = new ConfigBuilder();
