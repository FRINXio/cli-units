...
class RadiusTemplateReaderTest {

    private final String outputRadiusTemplates = """
    ...
    @Test
    void testRadiusTemplatesIds() {
        List<TemplateKey> keys = RadiusTemplateReader.getAllIds(outputRadiusTemplates);
        assertEquals(keys, Arrays.asList(new TemplateKey("default"),
