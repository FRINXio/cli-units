...
public class DomainListReaderTest {

    private final String outputDomains = " domain default\n"
            + " domain default_admin\n";

    @Test
    public void testDomainsIds() {
        List<DomainKey> keys = DomainListReader.getAllIds(outputDomains);
        Assert.assertEquals(keys, Arrays.asList(new DomainKey("default"),
