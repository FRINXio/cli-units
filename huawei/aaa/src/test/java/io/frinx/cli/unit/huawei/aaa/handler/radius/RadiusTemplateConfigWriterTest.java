...
public class RadiusTemplateConfigWriterTest {
    ...
    private static final String WRITE_WITH_ANOTHER_DATA = "system-view\n"
            + "radius-server template RADIUS-ZIGGO\n"
    ...
    @Test
    public void testWriteWithAnotherData() throws Exception {
