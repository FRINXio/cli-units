...
public class DomainListConfigWriterTest {
    ...
    private DomainListConfigWriter writer;
    ...
    private final InstanceIdentifier<Config> iid = IIDs.AA_AUG_AAAHUAWEISCHEMASAUG_DOMAINLIST
            .child(Domain.class, new DomainKey("test"))
            .child(Config.class);
    ...
    private final Config configWithData = new ConfigBuilder()
            .setName("test")
            .setAuthenticationScheme("AUT-ZIGGO")
            .setAccountingScheme("ACC-SC")
            .setRadiusServer("RADIUS-ZIGGO")
            .build();

    private final Config configWithAnotherData = new ConfigBuilder()
            .setName("test")
            .setAuthenticationScheme("radius")
            .setRadiusServer("default")
            .build();
    ...
    public void setUp() {
        ...
        writer = new DomainListConfigWriter(cli);
    }
