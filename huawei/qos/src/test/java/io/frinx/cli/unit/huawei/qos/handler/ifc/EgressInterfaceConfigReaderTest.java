...
public class EgressInterfaceConfigReaderTest {

    private static final String OUTPUT = "interface GigabitEthernet0/0/4.100\n"
    ...
    public void test() {
        ...
        EgressInterfaceConfigReader.fillInConfig(OUTPUT, configBuilder);
        final QosEgressInterfaceAug aug = configBuilder.getAugmentation(QosEgressInterfaceAug.class);
        Assert.assertEquals("TP-NNI-MAIN-OUT", aug.getServicePolicy());
    }
}
