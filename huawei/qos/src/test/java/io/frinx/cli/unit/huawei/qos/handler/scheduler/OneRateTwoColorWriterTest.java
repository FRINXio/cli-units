...
class OneRateTwoColorWriterTest {

    private static final String WRITE_INPUT_COLOR = """
            system-view
            traffic behavior VOICE
            car cir pct 30 mode color-blind green pass remark-8021p 3 yellow pass remark-8021p 2 red pass remark-8021p 2
            return
            """;
    ...
    private static final String UPDATE_INPUT = """
            system-view
            traffic behavior VOICE
            car cir pct 15 mode color-blind green pass remark-8021p 2 red pass remark-8021p 2
            return
            """;
...
//                                        .setTrafficAction(TrafficAction.Af)
    ...
    void write() throws WriteFailedException {
        ...
        assertEquals(WRITE_INPUT_COLOR, response.getValue().getContent());
    }
