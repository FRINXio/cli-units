...
class OneRateTwoColorYellowActionConfigReaderTest {
    ...
    void testTransmit() {
        ...
        assertEquals(true, configBuilder.isTransmit());
    }

    @Test
    void testCos() {
        OneRateTwoColorYellowActionConfigReader.parseConfig(OUTPUT_PCT, configBuilder);
        assertEquals(Cos.getDefaultInstance("2"), configBuilder.getCosTransmit());
    }
}
