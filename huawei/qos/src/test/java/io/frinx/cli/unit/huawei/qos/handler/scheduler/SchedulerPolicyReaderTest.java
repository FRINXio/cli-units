...
public class SchedulerPolicyReaderTest {
    ...
    private static final String OUTPUT = "traffic policy TP-NNI-BACKUP-OUT\n"
    ...
    public void testGetIds() {
        ...
        Assert.assertEquals(Lists.newArrayList("TP-NNI-BACKUP-OUT", "TP-NNI-MAIN-OUT", "TP-ASSURED-OUT"),
