...
public class ClassifierReaderTest {
    ...
    private static final String MAP_KEYS = "traffic classifier VOICE operator or\n"
            + "traffic classifier NNI operator or\n"
            + "traffic classifier VIDEO operator or";

    private static final String DEFAULT_KEYS = "traffic policy TP-NNI-BACKUP-OUT\n"
    ...
    public void testMapKeys() {
        ...
        Assert.assertEquals(Lists.newArrayList("VOICE", "NNI", "VIDEO"),
    ...
    public void testDefaultKeys() {
        ...
        Assert.assertFalse(keys.isEmpty());
        Assert.assertEquals(Lists.newArrayList("TP-NNI-BACKUP-OUT-default", "TP-NNI-MAIN-OUT-default",
