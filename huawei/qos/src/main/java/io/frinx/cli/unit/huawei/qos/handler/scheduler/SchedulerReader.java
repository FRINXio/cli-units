...
public class SchedulerReader implements CliConfigListReader<Scheduler, SchedulerKey, SchedulerBuilder> {
    ...
    static final String SH_POLICY_MAP = "display traffic policy user-defined %s";
    static final Pattern CLASS_NAME_LINE = Pattern.compile("Classifier: (?<name>.+)");
    private Cli cli;
    ...
    @NotNull
    @Override
    public List<SchedulerKey> getAllIds(@NotNull InstanceIdentifier<Scheduler> instanceIdentifier, @NotNull
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Scheduler> instanceIdentifier, @NotNull
            SchedulerBuilder builder, @NotNull ReadContext readContext) throws ReadFailedException {
