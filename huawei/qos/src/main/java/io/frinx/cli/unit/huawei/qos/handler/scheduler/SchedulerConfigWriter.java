...
public class SchedulerConfigWriter implements CliWriter<Config> {
    ...
    private static final String WRITE_TEMPLATE = """
            ...
            {% if ($class_name) %}classifier {$class_name}{% endif %}{% if ($vrp_aug.behavior) %} behavior {$vrp_aug.behavior}{% endif %}{% if ($vrp_aug.vrp_precedence) %} precedence {$vrp_aug.vrp_precedence}{% endif %}
            return""";
