...
public class InputReader implements CliConfigListReader<Input, InputKey, InputBuilder> {
    ...
    private static final String SH_POLICY_MAP_CLASSES = "display traffic policy user-defined %s";
    ...
    @NotNull
    @Override
    public List<InputKey> getAllIds(@NotNull InstanceIdentifier<Input> instanceIdentifier, @NotNull ReadContext
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Input> instanceIdentifier, @NotNull InputBuilder
            inputBuilder, @NotNull ReadContext readContext) {
