...
public class ClassifierReader implements CliConfigListReader<Classifier, ClassifierKey, ClassifierBuilder>  {
    ...
    public static final String SH_CLASS_MAPS = "display current-configuration | include traffic classifier";
    public static final Pattern CLASS_LINE = Pattern.compile("traffic classifier (?<name>\\S+).+");
    ...
    @NotNull
    @Override
    public List<ClassifierKey> getAllIds(@NotNull InstanceIdentifier<Classifier> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Classifier> instanceIdentifier,
                                      @NotNull ClassifierBuilder builder,
