...
public class BgpProtocolReader implements CliListReader<Protocol, ProtocolKey, ProtocolBuilder>,
    ...
    @NotNull
    @Override
    public List<ProtocolKey> getAllIds(@NotNull InstanceIdentifier<Protocol> iid,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Protocol> iid,
                                      @NotNull ProtocolBuilder builder,
    ...
    private void setBaseAttributes(@NotNull InstanceIdentifier<Protocol> iid, @NotNull ProtocolBuilder builder) {
