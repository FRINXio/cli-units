...
public class GlobalConfigReaderTest {
    ...
    public static final String OUTPUT_1 = "bgp 65222\n"
            + " router-id 198.18.100.5\r\n"
            + "  ipv4-family vpn-instance VLAN271752\r\n"
            + "  import-route static\r\n"
            + " ipv4-family vpn-instance VLAN278899 router-id 198.18.100.90\r\n"
            + "  import-route static\r\n"
            + "  import-route direct";

    public static final String OUTPUT_2 = "bgp 65222\n"
            + " router-id 198.18.100.5\r\n"
            + "  import-route direct\r\n"
            + "  import-route static\r\n"
            + " ipv4-family vpn-instance VLAN271752\r\n"
    ...
    @Test
    public void testDefaultNetworkParse1() {
    ...
    @Test
    public void testDefaultNetworkParse2() {
        ConfigBuilder configBuilder = new ConfigBuilder();
