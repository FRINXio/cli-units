...
public final class BrocadeInterfaceUnit implements TranslateUnit {
    ...
    private void provideWriters(ModifiableWriterRegistryBuilder writerRegistry, Cli cli) {
        ...
        writerRegistry.addAfter(new GenericWriter<>(TP_ID_AUG_ID, new TpIdInterfaceWriter(cli)),
                IIDs.IN_IN_CONFIG);
        ...
        writerRegistry.add(new GenericWriter<>(SUBIFC_VLAN_CFG_ID, new NoopCliWriter<>()));

        writerRegistry.add(new GenericWriter<>(SUBIFC_IPV4_ADDRESS_ID, new NoopCliListWriter<>()));
        writerRegistry.addAfter(new GenericWriter<>(SUBIFC_IPV4_CFG_ID, new Ipv4ConfigWriter(cli)),
                IIDs.IN_IN_CONFIG);
    }
    ...
    private void provideReaders(ModifiableReaderRegistryBuilder readRegistry, Cli cli) {
        ...
        readRegistry.add(new GenericConfigReader<>(TP_ID_AUG_ID, new TpIdInterfaceReader(cli)));
...
//        rRegistry.addStructuralReader(SUBIFC_VLAN_AUG_ID, org.opendaylight.yang.gen.v1.http.frinx.openconfig.net
// .yang.vlan.rev170714.Subinterface1Builder.class);
