...
public final class Vlan {
    ...
    static void buildConfiguration(@NotNull String ifcName, @NotNull org.opendaylight.yang.gen.v1.http.frinx.openconfig
            .net.yang.vlan.rev170714.vlan.routed.top.routed.vlan.ConfigBuilder configBuilder, @NotNull Vlan vlan) {
    ...
    static void buildConfiguration(@NotNull String ifcName, @NotNull ConfigBuilder configBuilder, @NotNull Vlan vlan) {
