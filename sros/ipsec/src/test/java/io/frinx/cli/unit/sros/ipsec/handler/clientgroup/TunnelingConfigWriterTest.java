...
public class TunnelingConfigWriterTest {
    @Mock
    private Cli cli;
    @Mock
    private WriteContext writeContext;
    private TunnelingConfigWriter target;
    ...
    private static final String PRIVATE_IFC_NAME = "PRIVATE-INTERFACE-001";
    private static final Long SERVICE_ID = Long.valueOf(200);
    private static final Long TEMPLATE_ID = Long.valueOf(300);
    ...
    private static final Config DATA = new ConfigBuilder()
        .setPrivateInterfaceName(PRIVATE_IFC_NAME)
        .setPrivateServiceId(SERVICE_ID)
        .setTunnelTemplateId(TEMPLATE_ID)
        .build();
    ...
    public void setUp() throws Exception {
        ...
        target = new TunnelingConfigWriter(cli);
    }
