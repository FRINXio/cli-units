...
class ClientConfigReaderTest {
    ...
    private static final String SH_RUN_ENABLED_OUTPUT = """
                                no shutdown
    ...
    private static final String SH_RUN_DISABLED_OUTPUT = """
                                shutdown
                                private-interface "PRIVATE-INTERFACE-001-001"
                                private-service 200
                                tunnel-template 300
    ...
    @Test
    void testReadCurrentAttributesEnabled() throws ReadFailedException {
        ...
        assertThat(builder.getClientId(), CoreMatchers.sameInstance(CLIENT_ID));
        assertThat(builder.isEnabled(), CoreMatchers.is(Boolean.TRUE));
    }

    @Test
    void testReadCurrentAttributesDisabled() throws ReadFailedException {
        ...
        assertThat(builder.getClientId(), CoreMatchers.sameInstance(CLIENT_ID));
        assertThat(builder.isEnabled(), CoreMatchers.is(Boolean.FALSE));
    }
}
