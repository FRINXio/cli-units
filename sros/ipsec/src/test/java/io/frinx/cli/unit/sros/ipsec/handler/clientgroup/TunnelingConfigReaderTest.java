...
public class TunnelingConfigReaderTest {
    @Mock
    private Cli cli;
    @Mock
    ...
    private static final String SH_RUN_OUTPUT = "                    shutdown\n"
    ...
    public void testReadCurrentAttributes() throws ReadFailedException {
        ...
        Assert.assertThat(builder.getPrivateInterfaceName(),
            CoreMatchers.equalTo("PRIVATE-INTERFACE-001"));

        Assert.assertThat(builder.getPrivateServiceId(),
            CoreMatchers.equalTo(Long.valueOf(200L)));

        Assert.assertThat(builder.getTunnelTemplateId(),
    ...
    public void testReadCurrentAttributesEmpty() throws ReadFailedException {
        ...
        Assert.assertThat(builder.getPrivateInterfaceName(), CoreMatchers.nullValue());
        Assert.assertThat(builder.getPrivateServiceId(), CoreMatchers.nullValue());
        Assert.assertThat(builder.getTunnelTemplateId(), CoreMatchers.nullValue());
    }
}
