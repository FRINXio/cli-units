...
public class CommunityReader implements CliConfigListReader<Community, CommunityKey, CommunityBuilder> {
    ...
    @Nonnull
    @Override
    public List<CommunityKey> getAllIds(@Nonnull InstanceIdentifier<Community> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@Nonnull InstanceIdentifier<Community> instanceIdentifier,
                                      @Nonnull CommunityBuilder communityBuilder,
                                      @Nonnull ReadContext readContext) throws ReadFailedException {
