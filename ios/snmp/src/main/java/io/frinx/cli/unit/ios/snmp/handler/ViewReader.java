...
public class ViewReader implements CliConfigListReader<View, ViewKey, ViewBuilder> {
    ...
    @NotNull
    @Override
    public List<ViewKey> getAllIds(@NotNull InstanceIdentifier<View> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<View> instanceIdentifier,
