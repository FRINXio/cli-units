...
import io.frinx.cli.unit.ios.bgp.handler.neighbor.NeighborWriterTest;
...
public class PeerGroupWriterTest implements CliFormatter {
    ...
    public PeerGroupWriterTest(String name, PeerGroup source, PeerGroup after, String write, String update, String
    ...
    public void test() throws Exception {
        ...
        NeighborWriter.renderNeighbor(writer, cli, id,
                ...
                PeerGroupWriter.getPeerGroupId(id), null, null, null, null, null, null, null, null,
        ...
        if (after != null) {
            NeighborWriter.renderNeighbor(writer, cli, id,
                    ...
                    afiSafisForGroupSource, PeerGroupWriter.getPeerGroupId(id), null, null, null, null, null, null,
                    null, null, PeerGroupWriter.PEER_GROUP_GLOBAL, PeerGroupWriter.PEER_GROUP_VRF);
        ...
        NeighborWriter.deleteNeighbor(writer, cli, id,
                ...
                null, PeerGroupWriter.PEER_GROUP_GLOBAL_DELETE, PeerGroupWriter.PEER_GROUP_VRF_DELETE);
