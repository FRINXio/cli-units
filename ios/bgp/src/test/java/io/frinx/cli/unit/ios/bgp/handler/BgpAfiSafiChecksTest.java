...
class BgpAfiSafiChecksTest {
     ...
     */
    @Test
    void checkValidAddressFamiliesCombinationTest1() {
     ...
     */
    @Test
    void checkValidAddressFamiliesCombinationTest2() {
     ...
     */
    @Test
    void checkValidAddressFamiliesCombinationTest3() {
     ...
     */
    @Test
    void checkInvalidAddressFamiliesCombinationTest1() {
     ...
     */
    @Test
    void checkInvalidAddressFamiliesCombinationTest2() {
        assertThrows(IllegalArgumentException.class, () -> {
            final NetworkInstanceKey networkInstanceKey = new NetworkInstanceKey("default");
            BgpAfiSafiChecks.checkAddressFamilies(networkInstanceKey, SAMPLE_BGP_CONFIG_3);
        });
     ...
     */
    @Test
    void checkInvalidAddressFamiliesCombinationTest3() {
        assertThrows(IllegalArgumentException.class, () -> {
            final NetworkInstanceKey networkInstanceKey = new NetworkInstanceKey("default");
