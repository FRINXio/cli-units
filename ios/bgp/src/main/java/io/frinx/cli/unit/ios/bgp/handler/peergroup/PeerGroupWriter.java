...
public class PeerGroupWriter implements CliListWriter<PeerGroup, PeerGroupKey> {
    ...
    @Override
    public void writeCurrentAttributes(@NotNull InstanceIdentifier<PeerGroup> instanceIdentifier,
            @NotNull PeerGroup neighbor, @NotNull WriteContext writeContext) throws WriteFailedException {
        ...
        NeighborWriter.renderNeighbor(this, cli, instanceIdentifier,
                ...
                null, null, null, null, null, null, null, null, PEER_GROUP_GLOBAL, PEER_GROUP_VRF);
    }
    ...
    @Override
    public void updateCurrentAttributes(@NotNull InstanceIdentifier<PeerGroup> instanceIdentifier,
                                        @NotNull PeerGroup before, @NotNull PeerGroup neighbor,
    ...
    @Override
    public void deleteCurrentAttributes(@NotNull InstanceIdentifier<PeerGroup> instanceIdentifier,
            @NotNull PeerGroup neighbor, @NotNull WriteContext writeContext) throws WriteFailedException {
        NetworkInstanceKey vrfKey = instanceIdentifier.firstKeyOf(NetworkInstance.class);
        ...
        NeighborWriter.deleteNeighbor(this, cli, instanceIdentifier, neighbor, vrfKey, bgpAs, groupAfiSafi, groupId,
                null, null, null, null, null, PEER_GROUP_GLOBAL_DELETE, PEER_GROUP_VRF_DELETE);
    }
