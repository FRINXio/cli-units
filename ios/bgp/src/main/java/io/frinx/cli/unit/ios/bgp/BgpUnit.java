...
import io.frinx.cli.unit.ios.bgp.handler.GlobalDefaultRouteDistanceReader;
import io.frinx.cli.unit.ios.bgp.handler.GlobalDefaultRouteDistanceWriter;
...
public class BgpUnit extends AbstractUnit {
    ...
    private void provideWriters(CustomizerAwareWriteRegistryBuilder writeRegistry, Cli cli) {
        ...
        writeRegistry.subtreeAddAfter(IIDs.NE_NE_PR_PR_BG_GL_DEFAULTROUTEDISTANCE,
                new GlobalDefaultRouteDistanceWriter(cli),
                Sets.newHashSet(IIDs.NE_NE_PR_PR_BG_GL_DE_CONFIG, IIDs.NE_NE_PR_PR_BG_GL_DE_STATE),
                IIDs.NE_NE_PR_PR_BG_NE_NEIGHBOR);
    ...
    private void provideReaders(@NotNull CustomizerAwareReadRegistryBuilder readRegistry, Cli cli) {
        ...
        readRegistry.add(IIDs.NE_NE_PR_PR_BG_GL_DEFAULTROUTEDISTANCE, new GlobalDefaultRouteDistanceReader(cli));
