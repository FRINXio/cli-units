...
public class AreaStateReader implements CliOperReader<State, StateBuilder> {

    // FIXME Duplicate code with config

    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<State> instanceIdentifier, @NotNull
            StateBuilder configBuilder, @NotNull ReadContext readContext) throws ReadFailedException {
