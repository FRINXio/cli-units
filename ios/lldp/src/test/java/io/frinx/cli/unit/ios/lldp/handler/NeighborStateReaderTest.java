...
class NeighborStateReaderTest {
    ...
    private static final State IOS_EXPECTED1 = new StateBuilder().setId("001e.bdb2.5200 Port:Gi3")
            .setPortId("Gi3")
            ...
            .setSystemDescription("""
                    Cisco IOS Software, CSR1000V Software (X86_64_LINUX_IOSD-UNIVERSALK9-M), Version 15.4(3)S1,\
                     RELEASE SOFTWARE (fc3)
                    Technical Support: http://www.cisco.com/techsupport
                    Copyright (c) 1986-2014 by Cisco Systems, Inc.
                    Compiled Fri 31-Oct-14 17:32 by mcpre""")
            .addAugmentation(CiscoLldpNeighborExtAug.class, new CiscoLldpNeighborExtAugBuilder()
                    .setSystemCapabilities("Bridge,Router")
                    .setEnabledCapabilities("Router").build())
            .build();

    private static final State IOS_EXPECTED2 = new StateBuilder().setId("0261.826a.a405 Port:Gi0/0/0/4")
            ...
            .addAugmentation(CiscoLldpNeighborExtAug.class, new CiscoLldpNeighborExtAugBuilder()
                    .setSystemCapabilities("Router")
                    .setEnabledCapabilities("Router").build())
            .build();

    @Test
    void testParseNeighborStateFields() {
