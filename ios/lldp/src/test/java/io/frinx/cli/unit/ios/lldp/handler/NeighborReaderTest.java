...
public class NeighborReaderTest {
    ...
    static final String SH_LLDP_NEIGHBOR = "------------------------------------------------\n"
            ...
            + "\n"
            + "System Description: \n"
            + "Cisco IOS Software, CSR1000V Software (X86_64_LINUX_IOSD-UNIVERSALK9-M), Version 15.4(3)S1, RELEASE "
            + "SOFTWARE (fc3)\n"
            ...
            + "\n"
            + "System Description: \n"
            + "Cisco IOS Software, CSR1000V Software (X86_64_LINUX_IOSD-UNIVERSALK9-M), Version 15.4(2)S, RELEASE "
            + "SOFTWARE (fc2)\n"
            + "Technical Support: http://www.cisco.com/techsupport\n"
            + "Copyright (c) 1986-2014 by Cisco Systems, Inc.\n"
