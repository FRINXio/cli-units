...
class ClassifierWriterTest {
    ...
    private static final String WRITE_ANY_QOS = """
            configure terminal
    ...
    private static final String WRITE_ANY_DSCP = """
            configure terminal
            class-map match-any map1
            match ip dscp 13
            end
    ...
    private static final String WRITE_ANY_COS = """
            configure terminal
            class-map match-any map1
    ...
    private static final String WRITE_ANY_ACL = """
            configure terminal
            class-map match-any map1
    ...
    void writeAny() throws WriteFailedException {
        ...
        assertEquals(WRITE_ANY_QOS, response.getAllValues().get(0).getContent());
        assertEquals(WRITE_ANY_DSCP, response.getAllValues().get(1).getContent());
        assertEquals(WRITE_ANY_COS, response.getAllValues().get(2).getContent());
        assertEquals(WRITE_ANY_ACL, response.getAllValues().get(3).getContent());
    }
