...
public class TermReader implements CliConfigListReader<Term, TermKey, TermBuilder> {
    ...
    @Nonnull
    @Override
    public List<TermKey> getAllIds(@Nonnull InstanceIdentifier<Term> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@Nonnull InstanceIdentifier<Term> instanceIdentifier,
                                      @Nonnull TermBuilder termBuilder, @Nonnull ReadContext readContext) {
