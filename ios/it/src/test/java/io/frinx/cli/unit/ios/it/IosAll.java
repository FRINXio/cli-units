...
import io.frinx.cli.unit.ios.bgp.BgpUnit;
...
import io.frinx.cli.unit.ios.privilege.PrivilegeUnit;
...
public class IosAll {
    ...
    private static final KeepaliveCli.ReconnectListener RECONNECT_LISTENER = new KeepaliveCli.ReconnectListener() {
        ...
        @Override
        public void onFailedConnection(Throwable throwable) {
...
//        localCli.setLevel(Level.TRACE);
    ...
    @Disabled
    @Test
    protected void getInterfacesBA() throws Exception {
    ...
    @Disabled
    @Test
    protected void getAllDOM() throws Exception {
    ...
    @Test
    protected void getAllDOMBenchmark() throws Exception {
        benchmark(2, 10, () -> {
            try {
                getAllDOM();
            } catch (Exception e) {
