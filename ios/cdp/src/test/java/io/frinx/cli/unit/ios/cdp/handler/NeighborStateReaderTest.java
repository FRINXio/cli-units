...
public class NeighborStateReaderTest {
    ...
    private static final String IOS_OUTPUT = "Device ID: TELNET\n"
            + "Interface: FastEthernet0/0,  Port ID (outgoing "
    ...
    private static final String XE_OUTPUT = "Device ID: TELNET\n"
            + "Interface: GigabitEthernet1,  Port ID (outgoing "
            + "port): FastEthernet0/0\n"
            + "Device ID: XE1.FRINX\n"
            + "Interface: GigabitEthernet1,  Port ID "
            + "(outgoing port): GigabitEthernet1\n"
            + "Device ID: PE1.demo.frinx.io\n"
            + "Interface: "
            + "GigabitEthernet1,  Port ID (outgoing port): MgmtEth0/0/CPU0/0\n"
