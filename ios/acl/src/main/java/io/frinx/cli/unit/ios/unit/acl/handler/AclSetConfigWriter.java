...
public class AclSetConfigWriter implements CliListWriter<AclSet, AclSetKey> {
    ...
    private static final String ACL_IPV4_STANDARD_WRITE = """
            configure terminal
            ip access-list standard {$aclName}
            end
            """;
    private static final String ACL_IPV4_EXTENDED_WRITE = """
            configure terminal
            ip access-list extended {$aclName}
            end
            """;
    private static final String ACL_IPV6_WRITE = """
            configure terminal
    ...
    private static final String ACL_IPV4_STANDARD_DELETE = """
            configure terminal
            no ip access-list standard {$aclName}
            end
            """;
    private static final String ACL_IPV4_EXTENDED_DELETE = """
            configure terminal
            no ip access-list extended {$aclName}
            end
            """;
    private static final String ACL_IPV6_DELETE = """
            configure terminal
