...
class EgressAclSetConfigWriterTest {
    ...
    @Test
    void writeAclSet_LAGInterface_goldenPath() throws WriteFailedException {
    ...
    @Test
    void writeAclSet_multipleForOneType() {
        presetWriteContext(context, TestData.INTERFACE_CORRECT_TYPE,
            TestData.EGRESS_ACL_SETS_MULTIPLE_FOR_TYPE,
        ...
        assertThat(actualMessage, containsString("Could not add more than one"));
    }
