...
class EgressAclSetReaderTest {
    ...
    void parseTest() {
        ...
        assertEquals(entry.getName(), setName);
        assertEquals(entry.getType(), AclUtil.getType(type, null));
    }

    @Test
    void readAclSet_LAGInterface() throws ReadFailedException {
    ...
    @Test
    void readAllAclIds() throws ReadFailedException {
        EgressAclSetReader reader = new EgressAclSetReader(cliMock);
