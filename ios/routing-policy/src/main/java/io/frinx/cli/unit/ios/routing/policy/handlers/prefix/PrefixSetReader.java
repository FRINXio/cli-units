...
public class PrefixSetReader implements CliConfigListReader<PrefixSet, PrefixSetKey, PrefixSetBuilder> {
    ...
    @NotNull
    @Override
    public List<PrefixSetKey> getAllIds(@NotNull InstanceIdentifier<PrefixSet> id,
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<PrefixSet> id,
                                      @NotNull PrefixSetBuilder builder,
                                      @NotNull ReadContext context) throws ReadFailedException {
