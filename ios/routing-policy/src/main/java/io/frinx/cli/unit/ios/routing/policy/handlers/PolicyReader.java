...
public class PolicyReader implements
    ...
    @Override
    public List<PolicyDefinitionKey> getAllIds(@Nonnull InstanceIdentifier<PolicyDefinition> instanceIdentifier,
    ...
    @Override
    public void readCurrentAttributes(@Nonnull InstanceIdentifier<PolicyDefinition> instanceIdentifier,
                                      @Nonnull PolicyDefinitionBuilder policyDefinitionBuilder,
                                      @Nonnull ReadContext readContext) throws ReadFailedException {
