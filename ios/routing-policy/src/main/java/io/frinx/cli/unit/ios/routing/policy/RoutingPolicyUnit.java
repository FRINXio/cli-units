...
public class RoutingPolicyUnit extends AbstractUnit {
    ...
    protected Set<Device> getSupportedVersions() {
        return Set.of(
            IosDevices.IOS_12,
            IosDevices.IOS_15,
            IosDevices.IOS_XE_15,
            IosDevices.IOS_XE_16,
            IosDevices.IOS_XE_17
        );
    }
    ...
    @Override
    public void provideHandlers(@NotNull CustomizerAwareReadRegistryBuilder readerRegistryBuilder,
                                @NotNull CustomizerAwareWriteRegistryBuilder writerRegistryBuilder,
    ...
    private void provideReaders(@NotNull CustomizerAwareReadRegistryBuilder readerRegistryBuilder, Cli cli) {
