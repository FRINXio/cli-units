...
public class ExtCommunitySetConfigWriter implements CliWriter<Config> {
    ...
    @Override
    public void writeCurrentAttributes(@NotNull InstanceIdentifier<Config> id, @NotNull Config dataAfter, @NotNull
    ...
    @Override
    public void deleteCurrentAttributes(@NotNull InstanceIdentifier<Config> id, @NotNull Config dataBefore, @NotNull
            WriteContext writeContext) throws WriteFailedException {
        ExtCommunitySetKey extCommunitySetKey = id.firstKeyOf(ExtCommunitySet.class);
        Optional<String> vrfName = ExtCommunitySetReader.getVrfName(extCommunitySetKey);
