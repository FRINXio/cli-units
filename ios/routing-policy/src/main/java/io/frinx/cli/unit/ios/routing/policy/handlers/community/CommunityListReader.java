...
public final class CommunityListReader implements
    ...
    @Nonnull
    @Override
    public List<CommunitySetKey> getAllIds(@Nonnull InstanceIdentifier<CommunitySet> id,
    ...
    @Override
    public void readCurrentAttributes(@Nonnull InstanceIdentifier<CommunitySet> id,
                                      @Nonnull CommunitySetBuilder builder,
