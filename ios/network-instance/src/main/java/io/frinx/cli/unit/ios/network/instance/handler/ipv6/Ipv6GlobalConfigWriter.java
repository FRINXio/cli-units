...
public final class Ipv6GlobalConfigWriter implements CliWriter<CiscoIpv6Config> {
    ...
    @Override
    public void writeCurrentAttributes(@NotNull InstanceIdentifier<CiscoIpv6Config> instanceIdentifier,
                                       @NotNull CiscoIpv6Config config,
                                       @NotNull WriteContext writeContext) throws WriteFailedException {
        executeCommandsOrThrowException(instanceIdentifier, config, false);
    }

    @Override
    public void updateCurrentAttributes(@NotNull InstanceIdentifier<CiscoIpv6Config> instanceIdentifier,
                                        @NotNull CiscoIpv6Config dataBefore,
                                        @NotNull CiscoIpv6Config dataAfter,
                                        @NotNull WriteContext writeContext) throws WriteFailedException {
        executeCommandsOrThrowException(instanceIdentifier, dataAfter, false);
    }

    @Override
    public void deleteCurrentAttributes(@NotNull InstanceIdentifier<CiscoIpv6Config> instanceIdentifier,
                                        @NotNull CiscoIpv6Config config,
                                        @NotNull WriteContext writeContext) throws WriteFailedException {
