...
public class VrfInterfaceWriter implements CliListWriter<Interface, InterfaceKey> {
    ...
    public void writeCurrentAttributes(@NotNull InstanceIdentifier<Interface> instanceIdentifier,
            @NotNull Interface anInterface, @NotNull WriteContext writeContext) throws WriteFailedException {
    ...
    @Override
    public void updateCurrentAttributes(@NotNull InstanceIdentifier<Interface> id, @NotNull Interface dataBefore,
                                        @NotNull Interface dataAfter, @NotNull WriteContext writeContext) throws
