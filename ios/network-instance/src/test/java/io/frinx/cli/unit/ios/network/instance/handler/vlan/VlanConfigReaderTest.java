...
class VlanConfigReaderTest {
    ...
    private static final String OUTPUT_UP = """
            vlan 12
             name up
            end
            """;
    ...
    private static final String OUTPUT_DOWN = """
            vlan 34
             name down
             shutdown
            end
    ...
    void test() {
        ...
        assertEquals(EXPECTED_UP, configBuilder.build());

        VlanConfigReader.parseVlanConfig(OUTPUT_DOWN, configBuilder, new VlanId(34));
        assertEquals(EXPECTED_DOWN, configBuilder.build());
    }
