...
public class Ipv6GlobalConfigReaderTest {

    private static final String IPV6_UNICAST_ROUTING_UP_OUTPUT = "ipv6 unicast-routing\n"
    ...
    private static final String IPV6_CEF_UP_OUTPUT = "IPv6 CEF is enabled and running centrally.\n"
            + "VRF Default\n"
    ...
    public void testConfigsUp() {
        ...
        Assert.assertEquals(true, builder.isUnicastRoutingEnabled());
        Assert.assertEquals(true, builder.isCefEnabled());
    }

    @Test
    public void testConfigsDown() {
        CiscoIpv6ConfigBuilder builder = new CiscoIpv6ConfigBuilder();
        Ipv6GlobalConfigReader.parseIpv6Config(builder, IPV6_UNICAST_ROUTING_DOWN_OUTPUT, IPV6_CEF_DOWN_OUTPUT);
        Assert.assertEquals(false, builder.isUnicastRoutingEnabled());
        Assert.assertEquals(false, builder.isCefEnabled());
    }

    @Test
    public void testCefUpUnicastDown() {
        CiscoIpv6ConfigBuilder builder = new CiscoIpv6ConfigBuilder();
