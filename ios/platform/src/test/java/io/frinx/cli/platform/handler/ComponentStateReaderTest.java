...
public class ComponentStateReaderTest {
    ...
    public static final String OUTPUT2 = "Mod Ports Card Type                              Model              Serial "
            + "No.\n"
            + "--- ----- -------------------------------------- ------------------ -----------\n"
    ...
    public static final String OUTPUT1 = "Mod Ports Card Type                              Model              Serial "
            + "No.\n"
            + "--- ----- -------------------------------------- ------------------ -----------\n"
    ...
    public static final String OUTPUT5 = "Mod Ports Card Type                              Model              Serial "
            + "No.\n"
            + "--- ----- -------------------------------------- ------------------ -----------\n"
    ...
    public static final String OUTPUT_VERSION = "Cisco IOS Software, 7200 Software (C7200-ADVIPSERVICESK9-M), Version"
            ...
            + "Last reload reason: unknown reload cause - suspect boot_data[BOOT_COUNT] 0x0, BOOT_COUNT 0, BOOTDATA "
            + "19\n"
            + "\n"
            + "\n"
            + "\n"
