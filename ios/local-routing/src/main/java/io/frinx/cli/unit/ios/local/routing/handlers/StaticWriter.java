...
public class StaticWriter implements CliListWriter<Static, StaticKey> {
    ...
    private static SubnetUtils.SubnetInfo getSubnetInfo(@NotNull IpPrefix config) {
    ...
    @Override
    public void writeCurrentAttributes(@NotNull InstanceIdentifier<Static> id, @NotNull Static config,
    ...
    @Override
    public void updateCurrentAttributes(@NotNull InstanceIdentifier<Static> id, @NotNull Static dataBefore,
            @NotNull Static dataAfter, @NotNull WriteContext writeContext) throws WriteFailedException {
    ...
    @Override
    public void deleteCurrentAttributes(@NotNull InstanceIdentifier<Static> id, @NotNull Static config,
                                        @NotNull WriteContext writeContext) throws WriteFailedException {
        NextHops nextHops = config.getNextHops();
        if (checkPreconditions(nextHops)) {
