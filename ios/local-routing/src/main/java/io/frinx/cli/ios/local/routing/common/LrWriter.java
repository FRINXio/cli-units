...
/**
 * Lr version of writer. A mixin that checks if LR type is set in the protocol in the background.
 */
public interface LrWriter<O extends DataObject> extends TypedWriter<O>, CliWriter<O>, L3VrfWriter<O> {
