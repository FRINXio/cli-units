...
XR5_folders=("Mount" "RSVP CRUD" "MPLS CRUD" "OSPF CRUD" "BGP CRUD" "5 LAG without BFD" "5 SNMP" "subinterface common CRUD" "Unmount")
ASR_folders=("Mount" "General information" "Interface" "Interface IP" "ospf" "static route" "Platform" "CDP" "LLDP" "subinterface common" "BGP summary" "5 LAG without BFD" "5 LAG with BFD" "5 SNMP" "Unmount")
