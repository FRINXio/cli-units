...
class L3VrfReaderTest {
    ...
    private static final String OUTPUT_VRFS = """
            set routing-instances router-A instance-type virtual-router\r
            set routing-instances router-B\r
            set routing-instances router-C instance-type virtual-router\r
    ...
    void testGetAllIds() throws Exception {
        ...
        assertEquals(EXPECTED_VRF_KEYS, result);
    }
}
