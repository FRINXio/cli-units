...
class VrfInterfaceReaderTest {
    ...
    private static final String SH_VRF_INTERFACES_OUTPUT = """
            set routing-instances VRF-001 interface ge-0/0/0.1
    ...
    @Test
    void testGetAllIdsForType() throws Exception {
    ...
    void testReadCurrentAttributesForType() throws Exception {
        ...
        assertThat(interfaceBuilder.getId(), CoreMatchers.sameInstance(IFC_NAME));
    }
}
