...
public class ApplyPolicyConfigWriterTest {
    ...
    public void testWriteCurrentAttributes() throws Exception {
        ...
        Assert.assertThat(commands.getAllValues().size(), CoreMatchers.is(2));
    ...
    public void testUpdateCurrentAttributes() throws Exception {
        ...
        Assert.assertThat(commands.getAllValues().size(), CoreMatchers.is(4));
        Assert.assertThat(commands.getAllValues().get(0).getContent(), CoreMatchers.equalTo(
