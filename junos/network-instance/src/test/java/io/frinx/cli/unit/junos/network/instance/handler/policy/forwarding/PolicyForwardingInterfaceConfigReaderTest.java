...
public class PolicyForwardingInterfaceConfigReaderTest {
    ...
    public void testReadCurrentAttributes() throws Exception {
        ...
        Assert.assertThat(builder.getInterfaceId().getValue(), CoreMatchers.sameInstance(INTERFACE_ID_VALUE));
        Assert.assertThat(builder.getAugmentation(NiPfIfJuniperAug.class)
