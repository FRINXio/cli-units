...
class JunosPromptResolutionStrategyTest {
    private static final String EXPECTED_PROMPT = "\r\nroot@VS999#";

    private static final String OUTPUT_EMPTY = "";
    private static final String OUTPUT_UNEXPECTED = """
            root@VS002#
            value1
            root@VS002#""";
    private static final String OUTPUT_NOT_TWO_LINES = """
            root@VS003#
            root@VS003#
            root@VS003#""";
    ...
    @Test
    void testResolvePrompt() throws Exception {
        ...
        //verify
        assertThat(result, CoreMatchers.equalTo(EXPECTED_PROMPT));
