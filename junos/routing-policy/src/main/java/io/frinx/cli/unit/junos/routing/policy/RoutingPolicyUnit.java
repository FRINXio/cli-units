...
package io.frinx.cli.unit.junos.routing.policy;
...
import io.frinx.cli.unit.junos.routing.policy.handler.actions.ActionsConfigReader;
import io.frinx.cli.unit.junos.routing.policy.handler.actions.ActionsConfigWriter;
import io.frinx.cli.unit.junos.routing.policy.handler.actions.ospf.actions.SetMetricConfigReader;
import io.frinx.cli.unit.junos.routing.policy.handler.actions.ospf.actions.SetMetricConfigWriter;
import io.frinx.cli.unit.junos.routing.policy.handler.conditions.protocol.ProtocolConfigReader;
import io.frinx.cli.unit.junos.routing.policy.handler.conditions.protocol.ProtocolConfigWriter;
import io.frinx.cli.unit.junos.routing.policy.handler.policy.PolicyConfigReader;
import io.frinx.cli.unit.junos.routing.policy.handler.policy.PolicyConfigWriter;
import io.frinx.cli.unit.junos.routing.policy.handler.policy.PolicyListReader;
import io.frinx.cli.unit.junos.routing.policy.handler.policy.StatementConfigReader;
import io.frinx.cli.unit.junos.routing.policy.handler.policy.StatementConfigWriter;
import io.frinx.cli.unit.junos.routing.policy.handler.policy.StatementListReader;
...
public class RoutingPolicyUnit extends AbstractUnit {
    ...
    public RoutingPolicyUnit(@NotNull final TranslationUnitCollector registry) {
        super(registry);
    }
