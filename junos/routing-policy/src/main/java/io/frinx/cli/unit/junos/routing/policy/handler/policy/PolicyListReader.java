...
public class PolicyListReader implements CliConfigListReader<PolicyDefinition, PolicyDefinitionKey,
    ...
    @NotNull
    @Override
    public List<PolicyDefinitionKey> getAllIds(@NotNull InstanceIdentifier<PolicyDefinition> id, @NotNull ReadContext
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<PolicyDefinition> id,
                                      @NotNull PolicyDefinitionBuilder builder,
