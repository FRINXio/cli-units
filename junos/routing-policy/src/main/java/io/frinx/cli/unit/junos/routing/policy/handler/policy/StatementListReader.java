...
public class StatementListReader implements
    ...
    @NotNull
    @Override
    public List<StatementKey> getAllIds(@NotNull InstanceIdentifier<Statement> id, @NotNull ReadContext
    ...
    @Override
    public void readCurrentAttributes(@NotNull InstanceIdentifier<Statement> id,
                                      @NotNull StatementBuilder builder,
