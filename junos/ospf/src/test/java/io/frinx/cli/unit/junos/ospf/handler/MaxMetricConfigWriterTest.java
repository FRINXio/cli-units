...
class MaxMetricConfigWriterTest {
    ...
    @Test
    void testWriteCurrentAttributesIsSetTrue() throws Exception {
        ...
        assertEquals(SET_MAX_METRIC, commands.getAllValues().get(0).getContent());
        assertEquals(DEACTIVATE_MAX_MATRIC, commands.getAllValues().get(1).getContent());
    }

    @Test
    void testWriteCurrentAttributesIsSetFalse() throws Exception {
        final Config data = Mockito.mock(Config.class);
        final ArgumentCaptor<Command> commands = ArgumentCaptor.forClass(Command.class);
    ...
    void testdeleteCurrentAttributes() throws Exception {
        ...
        assertEquals(DEL_MAX_METRIC, commands.getValue().getContent());
    }
}
