...
public class AreaInterfaceConfigReaderTest {
    ...
    public void testReadCurrentAttributesIsTarget() throws Exception {
        ...
        Assert.assertThat(builder.getNetworkType(), CoreMatchers.equalTo(POINTTOPOINTNETWORK.class));
        Assert.assertThat(builder.getMetric().getValue(), CoreMatchers.equalTo(500));
        Assert.assertThat(builder.getPriority(), CoreMatchers.equalTo(Short.valueOf("1")));
    }
}
