...
class OspfProtocolReaderTest {
    ...
    private static final String OUTPUT_VRF_PROTOCOLS = """
    ...
    private static final String OUTPUT_DEFAULT_PROTOCOLS =
            """
                    set protocols ospf area 10.51.246.22 interface xe-0/0/35.0 disable\r
                    set protocols ospf area 10.51.246.23 interface xe-0/0/36.0 disable\r
                    """;
    ...
    void testGetAllIds_001() throws Exception {
        ...
        assertThat(result, CoreMatchers.equalTo(EXPECTED_PROTOCOL_KEYS));
    ...
    void testReadCurrentAttributes() throws Exception {
        ...
        assertEquals(OspfProtocolReader.OSPF_NAME, builder.getName());
    }
}
