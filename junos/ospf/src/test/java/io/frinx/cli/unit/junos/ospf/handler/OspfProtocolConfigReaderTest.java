...
class OspfProtocolConfigReaderTest {
    @Mock
    private Cli cli;
    @Mock
    ...
    private static final String OUTPUT = """
            set policy-options policy-statement OUT-FIL term 1 from protocol direct\r
            set policy-options policy-statement OUT-FIL term 1 then metric 500\r
            set policy-options policy-statement OUT-FIL term 1 then accept\r
            set routing-instances APTN instance-type virtual-router\r
            set routing-instances APTN protocols ospf export OUT-FIL\r
            ...
            set routing-instances APTN protocols ospf area 10.51.246.21 interface xe-0/0/34.0\
             bfd-liveness-detection minimum-interval 150\r
            set routing-instances APTN protocols ospf area 10.51.246.21 interface xe-0/0/34.0\
             bfd-liveness-detection minimum-receive-interval 150\r
            set routing-instances APTN protocols ospf area 10.51.246.21 interface xe-0/0/34.0\
             bfd-liveness-detection multiplier 3\r
    ...
    void testReadCurrentAttributesIsTarget() throws Exception {
        ...
        assertThat(builder.getAugmentation(ProtocolConfAug.class).getExportPolicy(),
