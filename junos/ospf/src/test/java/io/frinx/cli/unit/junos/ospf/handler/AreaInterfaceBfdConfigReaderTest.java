...
class AreaInterfaceBfdConfigReaderTest {
    @Mock
    private Cli cli;
    @Mock
    ...
    void testReadCurrentAttributesIsTarget() throws Exception {
        ...
        assertThat(builder.getMinInterval(), CoreMatchers.equalTo(150L));
        assertThat(builder.getMinReceiveInterval(), CoreMatchers.equalTo(15L));
        assertThat(builder.getMultiplier(), CoreMatchers.equalTo(3L));
    }
}
