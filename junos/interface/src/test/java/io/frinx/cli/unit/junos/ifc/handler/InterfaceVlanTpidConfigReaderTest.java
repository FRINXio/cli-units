...
class InterfaceVlanTpidConfigReaderTest {
    ...
    void testReadCurrentAttributes_001() throws Exception {
        ...
        // verify
        assertEquals(TPID0X8100.class, config1Builder.getTpid());
    }
    ...
    void testReadCurrentAttributes_002() throws Exception {
        ...
        // verify
        assertNull(config1Builder.getTpid());
    }
    ...
    void testMerge() throws Exception {
        ...
        assertEquals(interfaceBuilder.getAugmentation(Config1.class), config1);
    }

    @Test
    void testGetBuilder() throws Exception {
        final String interfaceName = " ge-0/0/3";
        final InterfaceKey interfaceKey = new InterfaceKey(interfaceName);
        final InstanceIdentifier<Config1> instanceIdentifier = InstanceIdentifier.create(Interfaces.class)
            .child(Interface.class, interfaceKey).child(Config.class).augmentation(Config1.class);
        ...
        assertEquals(Config1Builder.class, target.getBuilder(instanceIdentifier).getClass());
    }
}
