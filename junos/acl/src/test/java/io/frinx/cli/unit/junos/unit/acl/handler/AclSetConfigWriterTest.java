...
public class AclSetConfigWriterTest {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.doReturn(Optional.absent()).when(writeContext).readBefore(Mockito.any());
    ...
    @Test
    public void testWriteCurrentAttributesWithIpv6() throws Exception {
    ...
    @Test
    public void testDeleteCurrentAttributesWithIpv6() throws Exception {
