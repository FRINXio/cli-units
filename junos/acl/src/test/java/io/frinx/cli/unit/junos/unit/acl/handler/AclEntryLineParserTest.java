...
class AclEntryLineParserTest {
    ...
    @Test
    void testUnsupportedIpv4AclWithMultSourceAddresses() {
    ...
    @Test
    void testUnsupportedIpv4AclWithMultSourcePorts() {
        assertThrows(IllegalArgumentException.class, () -> {
            final String lines = """
                Mon May 14 14:36:55.408 UTC
                set firewall family inet filter inacl1 term 1 from source-address 0.0.0.2/32
    ...
    @Test
    void testUnsupportedIpv6AclWithMultDestinationPorts() {
        assertThrows(IllegalArgumentException.class, () -> {
            final String lines = """
                Mon May 14 14:36:55.408 UTC
    ...
    @Test
    void testUnsupportedIpv6AclWithMultProtocols() {
        assertThrows(IllegalArgumentException.class, () -> {
            final String lines = """
                Mon May 14 14:36:55.408 UTC
                set firewall family inet filter inacl1 term 1 from destination-address ::1/128
    ...
    @Test
    void testUnsupportedIpv6AclWithUnknownOption() {
        assertThrows(IllegalArgumentException.class, () -> {
            final String lines = """
                Mon May 14 14:36:55.408 UTC
