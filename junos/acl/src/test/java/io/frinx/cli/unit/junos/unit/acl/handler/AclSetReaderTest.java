...
public class AclSetReaderTest {
    ...
    @Test
    public void parseAccessListsTest() {
        String output = "set firewall family inet filter FILTER1 term xy\n"
        ...
        Assert.assertEquals(reader.parseAccessLists(output), setKeys);
    }
}