...
public class AclEntriesWriter implements CliWriter<AclEntries> {
    ...
    @Override
    public void writeCurrentAttributes(@NotNull InstanceIdentifier<AclEntries> instanceIdentifier,
                                       @NotNull AclEntries aclEntries,
    ...
    @Override
    public void deleteCurrentAttributes(@NotNull InstanceIdentifier<AclEntries> instanceIdentifier,
                                        @NotNull AclEntries aclEntries,
                                        @NotNull WriteContext writeContext) throws WriteFailedException {
        Preconditions.checkNotNull(aclEntries.getAclEntry(), "Empty access list entries");
