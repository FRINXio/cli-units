...
public class AclInterfaceWriter implements CliListWriter<Interface, InterfaceKey> {
    ...
    @Override
    public void writeCurrentAttributes(@Nonnull InstanceIdentifier<Interface> instanceIdentifier,
                                       @Nonnull Interface dataAfter,
    ...
    @Override
    public void deleteCurrentAttributes(@Nonnull InstanceIdentifier<Interface> instanceIdentifier,
                                        @Nonnull Interface dataBefore,
                                        @Nonnull WriteContext writeContext) throws WriteFailedException {
        // This writer only has a check logic called when creating a container.
    }

    @Override
    public void updateCurrentAttributes(@Nonnull InstanceIdentifier<Interface> id,
                                        @Nonnull Interface dataBefore,
                                        @Nonnull Interface dataAfter,
                                        @Nonnull WriteContext writeContext) throws WriteFailedException {
        // This writer only has a check logic called when creating a container.
