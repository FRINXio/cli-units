...
class ConfigMetadataReaderTest {
    ...
    @Test
    void testGetLastConfigurationFingerprintExpected() throws Exception {
        ...
        assertThat(result.get(), CoreMatchers.equalTo(EXPECTED_LAST_COMMIT));
    }

    @Test
    void testGetLastConfigurationFingerprintMulti() throws Exception {
    ...
    @Test
    void testGetLastConfigurationFingerprintEmpty() throws Exception {
